...
function WorkbenchView(props) {
  ...
  const [showWizard, setShowWizard] = (0, import_react8.useState)(false);
  ...
  const projectView = () => (0, import_react8.createElement)(
    ...
    (0, import_react8.createElement)(
      ...
      (0, import_react8.createElement)(
        ...
        gate !== null && gate.status === "awaiting" ? (0, import_react8.createElement)(GatePanel, {
          gate,
          onDecide: decide,
          onRollback: rollback,
          busy,
        ...
        }) : meta.status === "awaiting-explore" ? (0, import_react8.createElement)(ExploreConfirmCard, {
          meta,
          exploreSummary,
          project: activeId,
          session: sessionRef.current,
          ...
          busy
        }) : meta.status === "awaiting-outline" ? (0, import_react8.createElement)(OutlineConfirmCard, {
          meta,
          busy,
          onConfirm: confirmOutline
        }) : meta.status === "awaiting-gold" ? (0, import_react8.createElement)(GoldTable, {
          meta,
          busy,
          goldDrafts,
          goldDraftVersion,
        ...
        }) : meta.status === "delivered" ? (0, import_react8.createElement)(DeliveryCard, {
          project: activeId,
          session: sessionRef.current,
          checks,
        ...
        }) : meta.phase === 5 && meta.demo !== true ? (0, import_react8.createElement)(ChaptersCard, {
          meta,
          chapterStatus,
          pendingReviews,
          progressDetail,
          ...
          postAction
          // F39 过目态内联展开/段级三键
        }) : meta.phase === 1 ? (0, import_react8.createElement)(UploadArea, {
          ...
          busy
        }) : (0, import_react8.createElement)(StatusCard, {
          meta,
          lastEvent,
          events,
