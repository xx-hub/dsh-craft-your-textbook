...
var ROLE_OPTIONS = ["\u5B66\u751F\u7528\u4E66", "\u6559\u5E08\u7528\u4E66", "\u8003\u7EB2", "\u8BB2\u4E49", "\u771F\u9898"];
...
function WizardCard(props) {
  ...
  const [route, setRoute] = (0, import_react.useState)("blueprint");
  const [science, setScience] = (0, import_react.useState)(false);
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      "div",
      null,
      (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, '\u{1F4DA} \u7B2C\u4E00\u6B65 \xB7 \u6750\u6599\u51C6\u5907\uFF1A\u5148\u7ED9\u4E66"\u5EFA\u6863"\uFF0810 \u79D2\uFF09\uFF0C\u7136\u540E\u5C31\u80FD\u4E0A\u4F20\u6559\u6750'),
      (0, import_react.createElement)("button", { style: { ...S.smallLink, float: "right" }, onClick: onCancel }, "\u53D6\u6D88")
    ),
    (0, import_react.createElement)(
      "div",
      { style: { marginTop: "8px" } },
      (0, import_react.createElement)("label", { style: { ...S.label, marginTop: "0" } }, "\u5B66\u4E60\u8005\u7684\u80CC\u666F\uFF08\u9009\u586B\uFF0C\u8BA9\u5EFA\u8BAE\u66F4\u8D34\u5207\uFF09"),
      (0, import_react.createElement)(
        "div",
    ...
    suggestions.length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "4px" } },
      (0, import_react.createElement)(
        "p",
        ...
        "\u70B9\u4E00\u4E2A AI \u5EFA\u8BAE\u81EA\u52A8\u586B\u597D\uFF08\u53EF\u518D\u6539\uFF09",
        (0, import_react.createElement)("button", { style: { ...S.smallLink, marginLeft: "10px" }, onClick: requestSuggest, disabled: suggestLoading }, "\u6362\u4E00\u6279")
      ),
      suggestions.map(
        (suggestion, index) => (0, import_react.createElement)("button", {
          key: index,
    ...
    ) : suggestLoading ? (0, import_react.createElement)("p", { style: { margin: "8px 0", fontSize: "12px", opacity: 0.7 } }, "\u{1F4A1} AI \u6B63\u5728\u60F3\u5EFA\u8BAE\u2026\u2026") : null,
    (0, import_react.createElement)("label", { style: S.label }, "\u4E66\u540D"),
    (0, import_react.createElement)("input", { style: S.input, placeholder: "\u6BD4\u5982\uFF1A\u521D\u4E2D\u6570\u5B66\xB7\u6709\u7406\u6570", value: name, onChange: (e) => setName(e.target.value) }),
    (0, import_react.createElement)("label", { style: S.label }, "\u8FD9\u672C\u4E66\u5B66\u5B8C\uFF0C\u8981\u80FD\u505A\u5230\u4EC0\u4E48\uFF1F"),
    (0, import_react.createElement)("textarea", { style: S.textarea, placeholder: "\u6BD4\u5982\uFF1A\u80FD\u72EC\u7ACB\u505A\u5BF9\u6559\u6750\u914D\u5957\u7684\u57FA\u7840\u9898\uFF0C\u5E76\u8BF4\u51FA\u6BCF\u4E2A\u6982\u5FF5\u662F\u4EC0\u4E48\u3001\u4E3A\u4EC0\u4E48\u3001\u600E\u4E48\u7528", value: goal, onChange: (e) => setGoal(e.target.value) }),
    (0, import_react.createElement)("label", { style: S.label }, "\u7ED9\u8C01\u7528\uFF1F"),
    (0, import_react.createElement)(
      "label",
      { style: S.checkItem },
      (0, import_react.createElement)("input", { type: "radio", name: "route", checked: route === "blueprint", onChange: () => setRoute("blueprint") }),
      " \u7ED9 AI \u8001\u5E08\u4E0A\u8BFE\u7528\uFF08\u63A8\u8350\uFF0C\u6559\u5B66\u7CBE\u5EA6\u6700\u9AD8\uFF09"
    ),
    (0, import_react.createElement)(
      "label",
      { style: S.checkItem },
      (0, import_react.createElement)("input", { type: "radio", name: "route", checked: route === "human", onChange: () => setRoute("human") }),
      " \u7ED9\u4EBA\u76F4\u63A5\u8BFB\u7684\u6559\u6750\uFF08AI \u4E5F\u80FD\u62FF\u5B83\u6559\uFF09"
    ),
    (0, import_react.createElement)(
      "label",
      { style: S.checkItem },
      (0, import_react.createElement)("input", { type: "checkbox", checked: science, onChange: (e) => setScience(e.target.checked) }),
      " \u7406\u79D1\u5185\u5BB9\uFF08\u516C\u5F0F\u8F83\u591A\uFF0C\u8F6C\u6362\u65F6\u5F00\u542F\u516C\u5F0F\u8BC6\u522B\uFF09"
    ),
    (0, import_react.createElement)(
      "label",
      { style: S.checkItem },
      (0, import_react.createElement)("input", { type: "checkbox", checked: agree, onChange: (e) => setAgree(e.target.checked) }),
      " \u6211\u786E\u8BA4\uFF1A\u53EA\u4E0A\u4F20\u6211\u6709\u6743\u4F7F\u7528\u7684\u6750\u6599\uFF1B\u9020\u51FA\u6765\u7684\u662F\u6559\u5B66\u53C2\u8003\uFF0CAI \u53EF\u80FD\u8BB2\u9519\uFF0C\u4F7F\u7528\u524D\u6211\u4F1A\u8BF7\u8001\u5E08/\u5BB6\u957F\u590D\u6838"
    ),
    error !== null ? (0, import_react.createElement)("p", { style: S.error }, error) : null,
    (0, import_react.createElement)(
      "div",
      { style: { marginTop: "8px" } },
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: submit, disabled: busy }, "\u521B\u5EFA\u8FD9\u672C\u4E66")
    ),
    (0, import_react.createElement)(
      "p",
    ...
    (0, import_react.createElement)(
      "div",
      { style: { marginTop: "12px", padding: "8px 10px", fontSize: "12px", lineHeight: 1.6, opacity: 0.75, border: "1px solid var(--dsw-border, #d0d7de)", borderRadius: "8px", background: "var(--dsw-surface, #fff)" } },
      (0, import_react.createElement)(
        "p",
        { style: { margin: "0 0 4px" } },
        "\u672C\u9879\u76EE\u662F",
        (0, import_react.createElement)("a", { href: "https://www.socratopia.app/r/SCR-FEJXMQ", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--dsw-accent, #4f6ef7)", textDecoration: "underline" } }, "\u3010\u7834\u5377\u3011"),
...
function UploadArea(props) {
  ...
  const [identifying, setIdentifying] = (0, import_react.useState)(false);
  const [uploading, setUploading] = (0, import_react.useState)(false);
  const [error, setError] = (0, import_react.useState)(null);
  const dirtyRef = (0, import_react.useRef)({});
  const pick = (e) => {
    setError(null);
  ...
  const identify = async (list) => {
    ...
    try {
      ...
      setPending((prev) => prev.map((item) => byName.has(item.name) && !dirtyRef.current[item.name] ? { ...item, role: byName.get(item.name) } : item));
    } catch {
    } finally {
  ...
  return (0, import_react.createElement)(
    "div",
    { style: S.focus },
    (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, "\u2460 \u4E0A\u4F20\u6559\u6750 PDF\uFF08\u53EF\u4E00\u6B21\u9009\u591A\u672C\uFF09"),
    (0, import_react.createElement)("p", { style: { margin: "4px 0 8px", fontSize: "12px", opacity: 0.7 } }, "\u4E66\u6587\u4EF6\u5939\u5EFA\u5728\u5F53\u524D\u5DE5\u4F5C\u533A\u76EE\u5F55\u91CC\uFF08\u6587\u4EF6\u5939\u540D\uFF1D\u4E66\u540D\uFF0C\u89C1\u4E0A\u65B9 \u{1F4C1} \u8DEF\u5F84\uFF09\uFF0C\u4E0A\u4F20\u7684 PDF \u90FD\u4FDD\u5B58\u5728\u91CC\u9762\u3002\u6BCF\u672C\u662F\u4EC0\u4E48\u89D2\u8272\u7531 AI \u81EA\u52A8\u8BC6\u522B\uFF0C\u4F60\u53EA\u9700\u8981\u786E\u8BA4\u3002"),
    (0, import_react.createElement)("label", { style: S.label }, "\u9009\u62E9 PDF\uFF08\u53EF\u591A\u9009\uFF09"),
    (0, import_react.createElement)("input", { type: "file", accept: ".pdf", multiple: true, style: S.input, onChange: pick }),
    pending.length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "8px" } },
      (0, import_react.createElement)(
        "div",
        { style: { display: "flex", alignItems: "center", gap: "6px", marginBottom: "4px" } },
        (0, import_react.createElement)("span", { style: { fontSize: "12px", fontWeight: 600 } }, `\u5F85\u4E0A\u4F20 ${pending.length} \u672C\uFF1A`),
        identifying ? (0, import_react.createElement)("span", { style: { fontSize: "12px", opacity: 0.7 } }, "\u2728 AI \u8BC6\u522B\u89D2\u8272\u4E2D\u2026") : (0, import_react.createElement)("span", { style: { fontSize: "12px", opacity: 0.7 } }, "\u2705 \u5DF2\u81EA\u52A8\u8BC6\u522B\uFF0C\u53EF\u4E0B\u62C9\u4FEE\u6539")
      ),
      pending.map(
        (item) => (0, import_react.createElement)(
          "div",
          { key: item.name, style: { display: "flex", gap: "8px", alignItems: "center", margin: "4px 0" } },
          (0, import_react.createElement)("span", { style: { flex: 1, fontSize: "12px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, item.name),
          (0, import_react.createElement)(
            "select",
            {
            ...
            ROLE_OPTIONS.map((role) => (0, import_react.createElement)("option", { key: role, value: role }, role))
          )
        )
      )
    ) : null,
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        "button",
        { style: { ...S.bigBtn(true), padding: "8px 14px" }, onClick: uploadAll, disabled: busy || uploading || pending.length === 0 },
        pending.length > 0 ? `\u4E0A\u4F20\u8FD9 ${pending.length} \u672C` : "\u4E0A\u4F20"
      )
    ),
    sources.length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "8px", fontSize: "12px", opacity: 0.85 } },
      (0, import_react.createElement)("div", { style: { margin: "0 0 4px" } }, `\u5DF2\u4E0A\u4F20 ${sources.length} \u672C\uFF1A`),
      sources.map((source) => (0, import_react.createElement)(
        "div",
        { key: source.file, style: { wordBreak: "break-all", margin: "2px 0" } },
    ...
    sources.length > 0 ? (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: onConvert, disabled: busy || converting }, "\u2461 \u5F00\u59CB\u8F6C\u6362\uFF08\u673A\u5668\u81EA\u52A8\u8DD1\uFF09"),
      converting ? (0, import_react.createElement)("span", { style: { marginLeft: "8px", fontSize: "12px" } }, "\u8F6C\u6362\u4E2D\u2026\u2026") : null
    ) : null
  );
}
function StatusCard(props) {
  ...
  if (meta.status === "error") {
    ...
    return (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("strong", { style: { color: "var(--dsw-danger, #cf222e)" } }, "\u26A0\uFE0F \u8FD9\u4E00\u6B65\u51FA\u9519\u4E86"),
      (0, import_react.createElement)("p", { style: { margin: "6px 0" } }, humanError),
      (0, import_react.createElement)(
        "p",
        { style: { margin: "6px 0 0", fontSize: "13px", opacity: 0.9 } },
        "\u4F60\u53EF\u4EE5\uFF1A\u628A PDF \u62C6\u6210\u51E0\u4EFD\uFF08\u6BCF\u4EFD <200 \u9875\uFF09\u540E\u5206\u522B\u4E0A\u4F20\uFF0C\u6216\u6362\u4E00\u672C\u66F4\u8584\u7684\u4E66\uFF0C\u6216\u5220\u6389\u8FD9\u672C\u4E66\u91CD\u65B0\u5F00\u59CB\u3002"
      ),
      isTokenIssue ? (0, import_react.createElement)(
        "p",
        { style: { margin: "4px 0 0", fontSize: "13px", opacity: 0.9 } },
        "\u{1F4A1} MinerU Token \u53EF\u80FD\u5931\u6548\uFF0C\u53EF\u5230\u5DE5\u4F5C\u53F0\u300CMinerU Token\u300D\u5904\u70B9\u300C\u91CD\u65B0\u8BBE\u7F6E\u300D\u6362\u65B0 Token\u3002"
      ) : null,
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: onResume, disabled: busy }, "\u{1F501} \u91CD\u8BD5"),
      // F28（2026-08-20 走查）：上传错了给「删书重来」入口——两步确认（第一态→确认态），
      // 确认按钮只受 busy 置灰；删除后回向导可马上建一本新书。仅在父级传入删除回调时显示。
      typeof onDeleteStart === "function" ? (0, import_react.createElement)(
        "div",
        { style: { marginTop: "8px", paddingTop: "8px", borderTop: "1px dashed var(--dsw-border, #d0d7de)" } },
        (0, import_react.createElement)(
          "p",
          { style: { margin: "0 0 6px", fontSize: "13px", opacity: 0.9 } },
          "\u4E0A\u4F20\u9519\u4E86\uFF1F\u53EF\u4EE5\u5220\u6389\u8FD9\u672C\u4E66\u91CD\u65B0\u5EFA\u4E00\u672C\uFF08\u65E7\u4E66\u8FDB\u56DE\u6536\u7AD9\uFF09\uFF0C\u56DE\u5230\u5411\u5BFC\u9A6C\u4E0A\u5C31\u80FD\u5F00\u59CB\u65B0\u4E66\u3002"
        ),
        deletingId === true ? (0, import_react.createElement)("button", {
          style: { ...S.smallLink, color: "var(--dsw-danger, #cf222e)" },
          onClick: onDeleteConfirm,
          disabled: busy
        }, "\u786E\u8BA4\u5220\u9664\u8FD9\u672C\u4E66\uFF08\u8FDB\u56DE\u6536\u7AD9\uFF09") : (0, import_react.createElement)("button", {
          style: { ...S.smallLink, color: "var(--dsw-danger, #cf222e)" },
  ...
  if (meta.status === "needs-config") {
    return (0, import_react.createElement)(
      "div",
      { style: { ...S.focus, borderColor: "var(--dsw-danger, #cf222e)" } },
      (0, import_react.createElement)("strong", { style: { color: "var(--dsw-danger, #cf222e)" } }, "\u{1F511} \u9700\u8981\u5148\u914D\u7F6E"),
      (0, import_react.createElement)("p", { style: { margin: "6px 0" } }, needsConfig),
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: onResume, disabled: busy }, "\u6211\u914D\u597D\u4E86\uFF0C\u7EE7\u7EED")
    );
  }
  let label = "";
  let extra = "";
  if (typeof pendingStageLabel === "string" && pendingStageLabel !== "") {
    ...
    if (data.label !== void 0 && data.label !== null && data.label !== "") label = data.label;
  ...
  if (phase === 5) {
    ...
    if (total > 0) {
      const done = (events ?? []).filter((e) => e.type === "textbook/agent-end" && typeof e.data?.label === "string" && e.data.label.includes("\u5B8C\u6210\uFF08\u5C0F\u52A9\u624B\u6267\u7B14")).length;
  ...
  const stale = !aiActive && elapsedMs > 8 * 60 * 1e3;
  return (0, import_react.createElement)(
    "div",
    { style: S.focus },
    (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, `\u23F3 ${label || "\u51C6\u5907\u4E2D\u2026"}`),
    extra !== "" ? (0, import_react.createElement)("p", { style: { margin: "6px 0 0", opacity: 0.9 } }, `\u23F3 ${extra}`) : null,
    phaseDesc !== void 0 ? (0, import_react.createElement)("p", { style: { margin: "6px 0 0", opacity: 0.85 } }, `\u{1F4CC} ${phaseDesc}`) : null,
    chapterProgress !== null ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "10px" } },
      (0, import_react.createElement)(
        "div",
        { style: { display: "flex", justifyContent: "space-between", fontSize: "12px", marginBottom: "4px" } },
        (0, import_react.createElement)("span", { style: { opacity: 0.8 } }, "\u7AE0\u8282\u5199\u4F5C\u8FDB\u5EA6"),
        (0, import_react.createElement)("span", { style: { opacity: 0.8 } }, `\u5DF2\u5B8C\u6210 ${chapterProgress.done}/${chapterProgress.total} \u7AE0`)
      ),
      (0, import_react.createElement)(
        "div",
        { style: { height: "8px", borderRadius: "4px", background: "var(--dsw-border, #d0d7de)", overflow: "hidden" } },
    ...
    (0, import_react.createElement)("p", { style: { margin: "6px 0 0", fontSize: "12px", opacity: 0.7 } }, `\u23F1 \u8FD9\u4E00\u6B65\u5DF2\u8FDB\u884C ${fmt(elapsedMs)}`),
    stale ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "8px", padding: "8px 10px", border: "1px solid #d4a72c", borderRadius: "8px", background: "var(--dsw-warn-soft, #fff8e1)" } },
      (0, import_react.createElement)("span", { style: { fontSize: "13px" } }, `\u26A0\uFE0F \u5DF2\u7ECF ${fmt(elapsedMs)} \u6CA1\u6709\u65B0\u52A8\u9759\u4E86\uFF0C\u53EF\u80FD\u5361\u4F4F\u4E86\u3002\u5230\u5BF9\u8BDD\u9875\u786E\u8BA4\u4E00\u4E0B\uFF1A\u5982\u679C\u771F\u5361\u4F4F\u4E86\uFF0C\u5728\u5BF9\u8BDD\u91CC\u53D1\u4E00\u53E5\u300C\u7EE7\u7EED\u300D\uFF08\u6216\u70B9\u8FD9\u91CC\u91CD\u8BD5\uFF09\u5524\u9192 AI\u3002`),
      (0, import_react.createElement)("button", { style: { ...S.bigBtn(true), marginLeft: "8px", padding: "4px 12px" }, onClick: onResume, disabled: busy }, "\u{1F501} \u91CD\u8BD5")
    ) : (0, import_react.createElement)("p", { style: { margin: "6px 0 0", fontSize: "12px", opacity: 0.85 } }, `\u{1F916} AI \u6B63\u5728\u5E72\u6D3B\uFF0C\u5DF2\u8FDB\u884C ${fmt(elapsedMs)}`),
    (0, import_react.createElement)("p", { style: { margin: "6px 0 0", opacity: 0.8 } }, "\u4E3B AI \u6B63\u5728\u4EB2\u624B\u505A\u8FD9\u4E00\u6B65\uFF08\u4E0B\u65B9\u5BF9\u8BDD\u53F0\u91CC\u80FD\u770B\u5230\u5B83\u73B0\u573A\u5E72\u6D3B\uFF09\uFF1B\u8F6E\u5230\u4F60\u9700\u8981\u62CD\u677F/\u786E\u8BA4\u65F6\u4F1A\u4EAE\u8D77 \u26A1\uFF0C\u4F60\u968F\u65F6\u53EF\u4EE5\u5728\u5BF9\u8BDD\u91CC\u95EE\u5B83\u3002")
  );
}
function DeliveryCard(props) {
  ...
  return (0, import_react.createElement)(
    "div",
    { style: S.focus },
    (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, "\u{1F389} \u4E66\u505A\u597D\u4E86\uFF01"),
    aiReport !== null && aiReport !== void 0 && aiReport !== "" ? (0, import_react.createElement)(
      "div",
      { style: { margin: "10px 0", padding: "8px 10px", background: "var(--dsw-accent-soft, #eef2ff)", borderRadius: "8px", fontSize: "12px" } },
      (0, import_react.createElement)("strong", null, "\u{1F916} AI \u81EA\u67E5\u8BF4\u7684\uFF1A"),
      (0, import_react.createElement)("p", { style: { margin: "4px 0 0", whiteSpace: "pre-wrap" } }, aiReport)
    ) : null,
    (0, import_react.createElement)(
      "div",
      { style: { margin: "10px 0" } },
      (checks ?? []).map(
        (check) => (0, import_react.createElement)(
          "div",
          { key: check.name, style: { margin: "4px 0" } },
          (0, import_react.createElement)("span", null, check.ok === true ? "\u2705" : "\u274C"),
          ` ${check.name}`,
          (0, import_react.createElement)("span", { style: { opacity: 0.7, marginLeft: "6px", fontSize: "12px" } }, check.note ?? "")
        )
      )
    ),
    (styleNotes ?? []).length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { margin: "10px 0", padding: "8px 10px", borderRadius: "8px", border: "1px solid var(--dsw-border, #d0d7de)" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontWeight: 600 } }, "\u{1F3A8} \u4F60\u7684\u98CE\u683C\u7EBF\u6761\u6761\u6709\u7740\u843D"),
      ...(styleNotes ?? []).map((note, index) => (0, import_react.createElement)(
        "div",
        { key: note.id ?? index, style: { fontSize: "12px", margin: "3px 0" } },
        `${note.status === "superseded" ? "\xB7\uFF08\u5DF2\u6536\u56DE\uFF09" : note.status === "conflict" ? "\xB7\uFF08\u4E0E\u8BBE\u8BA1\u51B2\u7A81\uFF0C\u7406\u7531\u89C1\u5907\u6CE8\uFF09" : "\xB7"}${note.text}`,
        note.note ? (0, import_react.createElement)("span", { style: { opacity: 0.6 } }, ` -- ${note.note}`) : null
      ))
    ) : null,
    (0, import_react.createElement)(
      "p",
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: onPreview, disabled: busy }, preview === null ? "\u{1F440} \u9884\u89C8\u6210\u54C1" : "\u6536\u8D77\u9884\u89C8"),
    ...
    preview !== null ? (0, import_react.createElement)("pre", { style: { whiteSpace: "pre-wrap", background: "var(--dsw-surface, #fff)", borderRadius: "8px", padding: "10px", maxHeight: "300px", overflow: "auto", fontSize: "12px" } }, preview) : null,
    (0, import_react.createElement)(
      "div",
      { style: { margin: "8px 0 0", opacity: 0.8 } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px", fontWeight: 600 } }, "\u{1F4A1} \u8FD9\u672C\u4E66\u600E\u4E48\u7528"),
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px" } }, `\u7ED9 AI \u8001\u5E08\u4E0A\u8BFE \u2192 \u628A\u4E0B\u8F7D\u7684\u300A${bookName}\u300B.md \u4EA4\u7ED9\u3010\u7834\u5377\u3011\uFF08https://www.socratopia.app/r/SCR-FEJXMQ\uFF09\u4F5C\u4E3A\u6559\u6750\u8FDB\u884C\u5B66\u4E60\u3002\u3010\u5EFA\u8BAE\u3011`),
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px" } }, "\u7ED9\u4EBA\u8BFB \u2192 \u76F4\u63A5\u9605\u8BFB\u6216\u6253\u5370\u3002\u5EFA\u8BAE\u5148\u590D\u6838\u4E00\u904D\u518D\u7528\u3002"),
      (0, import_react.createElement)("p", { style: { margin: "0" } }, "\u5982\u679C\u672C\u9879\u76EE\u5BF9\u4F60\u6709\u5E2E\u52A9\uFF0C\u6B22\u8FCE\u586B\u5199\u9080\u8BF7\u7801\uFF1ASCR-FEJXMQ\uFF0C\u53EF\u514D\u8D39\u9886\u53D6 100 \u4E07 tokens\uFF0C\u5168\u573A\u5B98\u65B9\u9020\u4E66\u514D\u8D39\u5B66\u4E60\u3002")
    )
  );
}
var REASONS = ["\u8BB2\u5F97\u592A\u6DF1\u4E86", "\u8BB2\u5F97\u592A\u6D45\u4E86", "\u4E0D\u662F\u6211\u8981\u7684\u91CD\u70B9", "\u548C\u522B\u7684\u90E8\u5206\u91CD\u590D", "\u6362\u4E2A\u98CE\u683C"];
...
function GatePanel(props) {
  ...
  if (gate.status !== "awaiting") {
    ...
    return (0, import_react.createElement)(
      "div",
      { style: S.focus },
      (0, import_react.createElement)("strong", null, decided ? `\u2705 \u7B2C ${gate.gate} \u5173\u5DF2\u901A\u8FC7\uFF08v${gate.version}\uFF09` : `\u21A9\uFE0F \u7B2C ${gate.gate} \u5173\u5DF2\u9A73\u56DE\uFF08v${gate.version}\uFF09\uFF0C\u7B49 AI \u4FEE\u8BA2`),
      decided ? (0, import_react.createElement)("p", { style: { margin: "6px 0 0", opacity: 0.8 } }, "\u4E4B\u540E\u968F\u65F6\u80FD\u6539\uFF1A\u56DE\u9000\u53EF\u4EE5\u56DE\u5230\u8FD9\u4E00\u5173\u4E4B\u524D\u7684\u4EFB\u4F55\u7248\u672C\u3002") : (0, import_react.createElement)("p", { style: { margin: "6px 0 0", opacity: 0.8 } }, "AI \u6B63\u5728\u6309\u4F60\u7684\u610F\u89C1\u4FEE\u6539\uFF0C\u65B0\u7248\u63D0\u6848\u4F1A\u51FA\u73B0\u5728\u8FD9\u91CC\u3002"),
      (0, import_react.createElement)(
        "div",
        { style: { marginTop: "8px" } },
        (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => onRollback() }, "\u23EA \u56DE\u9000\u5230\u4E0A\u4E00\u4E2A\u62CD\u677F\u70B9")
      )
    );
  }
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      "div",
      null,
      (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, `\u{1F6A6} \u8BF7\u4F60\u62CD\u677F \xB7 \u7B2C ${gate.gate} \u5173 \xB7 \u65B9\u6848 v${gate.version}`),
      (0, import_react.createElement)("span", { style: { float: "right", opacity: 0.6, fontSize: "12px" } }, "\u8FD9\u4E00\u5173\u4E0D\u8FC7\uFF0C\u6D41\u7A0B\u4E0D\u4F1A\u7EE7\u7EED")
    ),
    (0, import_react.createElement)("p", { style: { margin: "10px 0 6px" } }, gate.title),
    (0, import_react.createElement)("p", { style: { margin: "0 0 6px", opacity: 0.9, lineHeight: 1.6 } }, gate.summary),
    (0, import_react.createElement)(
      "div",
      { style: { margin: "6px 0" } },
      (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => setShowDetail(!showDetail) }, showDetail ? "\u6536\u8D77\u5B8C\u6574\u65B9\u6848" : "\u5C55\u5F00\u5B8C\u6574\u65B9\u6848"),
      gate.prevProposal !== null ? (0, import_react.createElement)(
        "span",
        null,
        "\u3000",
        (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => setShowCompare(!showCompare) }, showCompare ? "\u6536\u8D77\u5BF9\u6BD4" : `\u5BF9\u6BD4\u4E0A\u4E00\u7248\uFF08v${gate.prevProposal.version}\uFF09`)
      ) : null
    ),
    showDetail && (gate.detail ?? "") !== "" ? (0, import_react.createElement)("pre", { style: { whiteSpace: "pre-wrap", background: "var(--dsw-surface, #fff)", borderRadius: "8px", padding: "10px", fontSize: "12px", opacity: 0.9, maxHeight: "260px", overflow: "auto" } }, gate.detail) : null,
    showCompare && gate.prevProposal !== null ? (0, import_react.createElement)(
      "div",
      { style: { background: "var(--dsw-surface, #fff)", borderRadius: "8px", padding: "10px", fontSize: "12px", opacity: 0.9 } },
      (0, import_react.createElement)("strong", null, `\u4E0A\u4E00\u7248 v${gate.prevProposal.version}\uFF1A`),
      (0, import_react.createElement)("p", { style: { margin: "4px 0 0" } }, gate.prevProposal.summary)
    ) : null,
    error !== null ? (0, import_react.createElement)("p", { style: S.error }, error) : null,
    rejecting ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "10px", borderTop: "1px dashed var(--dsw-border, #d0d7de)", paddingTop: "8px" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontWeight: 600 } }, "\u9A73\u56DE\u539F\u56E0\uFF08\u9009\u4E00\u4E2A\uFF0C\u4E0D\u5FC5\u6253\u5B57\uFF09"),
      (0, import_react.createElement)(
        "div",
        { style: { margin: "8px 0" } },
        (0, import_react.createElement)(
          ...
          (0, import_react.createElement)("input", { type: "radio", name: "mode", checked: mode === "wrong", onChange: () => setMode("wrong") }),
          " \u65B9\u6848\u4E0D\u5BF9 \u2014\u2014 AI \u91CD\u505A\u4E00\u7248"
        ),
        (0, import_react.createElement)(
          "label",
          { style: { display: "block", margin: "4px 0" } },
          (0, import_react.createElement)("input", { type: "radio", name: "mode", checked: mode === "confused", onChange: () => setMode("confused") }),
          " \u6211\u770B\u4E0D\u61C2 / \u4E0D\u662F\u6211\u8981\u7684 \u2014\u2014 AI \u6362\u4EBA\u8BDD\u91CD\u8BB2\u3001\u7ED9\u4F8B\u5B50"
        )
      ),
      (0, import_react.createElement)("p", { style: { margin: "6px 0 4px", fontWeight: 600 } }, "\u5177\u4F53\u54EA\u91CC\u4E0D\u6EE1\u610F\uFF08\u53EF\u591A\u9009\uFF09"),
      REASONS.map((reason) => (0, import_react.createElement)(
        "label",
        { key: reason, style: S.checkItem },
        (0, import_react.createElement)("input", { type: "checkbox", checked: reasons.includes(reason), onChange: () => toggleReason(reason) }),
        ` ${reason}`
      )),
      // 2026-08-21：勾选「换个风格」→ 弹出粘贴窗口，目标文本由 AI 分析成这本书的自定义模式。
      reasons.includes("\u6362\u4E2A\u98CE\u683C") ? (0, import_react.createElement)(
        "div",
        { style: { marginTop: "4px" } },
        (0, import_react.createElement)(
          "p",
      ...
      (0, import_react.createElement)("textarea", { style: S.textarea, placeholder: "\u60F3\u591A\u8BF4\u4E00\u53E5\uFF1F\u5728\u8FD9\u91CC\u8865\u5145\uFF08\u53EF\u9009\uFF09", value: note, onChange: (e) => setNote(e.target.value) }),
      (0, import_react.createElement)(
        "div",
        { style: { marginTop: "8px", display: "flex", gap: "8px" } },
        (0, import_react.createElement)("button", { style: S.bigBtn(false), onClick: submitReject, disabled: busy }, "\u63D0\u4EA4\u9A73\u56DE"),
        (0, import_react.createElement)("button", { style: { ...S.smallLink, textDecoration: "none" }, onClick: () => {
          setRejecting(false);
          setStyleText("");
        } }, "\u53D6\u6D88")
      )
      ...
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: () => onDecide({ approved: true }), disabled: busy }, "\u2705 \u901A\u8FC7\uFF0C\u7EE7\u7EED"),
      (0, import_react.createElement)("button", { style: S.bigBtn(false), onClick: () => setRejecting(true), disabled: busy }, "\u274C \u9A73\u56DE\uFF0C\u63D0\u610F\u89C1")
    ),
    (0, import_react.createElement)(
      "div",
      { style: { marginTop: "10px" } },
      (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => onRollback(), disabled: busy }, "\u23EA \u56DE\u9000\u5230\u4E0A\u4E00\u4E2A\u62CD\u677F\u70B9")
    )
  );
}
...
function assistantBlocks(blocks) {
  ...
  for (const block of blocks ?? []) {
    ...
    else if (block?.kind === "tool-call") parts.push(`\u{1F527} \u8C03\u7528\u5DE5\u5177\uFF1A${block.name ?? ""}`);
...
function contentBlocksText(blocks) {
  ...
  for (const block of blocks ?? []) {
    ...
    else if (block?.type === "tool_use") parts.push(`\u{1F527} \u8C03\u7528\u5DE5\u5177\uFF1A${block.name ?? ""}`);
  }
  return parts.join("\n");
}
...
function muted(text) {
  return (0, import_react.createElement)("p", { style: { margin: "3px 0", fontSize: "11px", opacity: 0.55, whiteSpace: "pre-wrap", wordBreak: "break-word" } }, text);
}
var RECEIPT_TEXT = {
...
function ChatDesk(props) {
  ...
  const deskScrollRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
  ...
  for (const e of events) {
    ...
    for (let i = 0; i < assistantTimes.length; i += 1) {
      ...
      if (Number.isFinite(t) && e.time >= t && e.time - t < 5 * 60 * 1e3) best = i;
    }
    if (best >= 0) {
  ...
  for (const node of nodes ?? []) {
    ...
    switch (node.kind) {
      ...
      case "tool":
        ...
        break;
      case "turn-error":
        push(bubble("assistant", `\u26A0\uFE0F \u51FA\u9519\u4E86\uFF1A${data.message ?? node.message ?? ""}`, { color: "var(--dsw-danger, #cf222e)" }));
        break;
      case "model-retry":
      case "retry":
        push(muted(`\u21BB \u6A21\u578B\u81EA\u52A8\u91CD\u8BD5\uFF08\u7B2C ${(data.attempts ?? []).length + 1} \u6B21\uFF09`));
        break;
      case "command":
      case "command-input":
  ...
  return (0, import_react.createElement)(
    ...
    onCollapse !== null ? (0, import_react.createElement)(
      "div",
      { style: { position: "sticky", top: 0, background: "inherit", textAlign: "right" } },
      (0, import_react.createElement)("button", { style: S.smallLink, onClick: onCollapse }, "\u6536\u6210\u4E00\u6761")
    ) : null,
    (0, import_react.createElement)(
      "div",
      { style: { display: "flex", flexDirection: "column", padding: "10px 12px", minHeight: "100%", boxSizing: "border-box" } },
      ...items,
...
function AutoOpenWorkbench(props) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const target = [...document.querySelectorAll('[role="tab"]')].find((el) => (el.textContent ?? "").trim() === "\u5DE5\u4F5C\u53F0");
...
var OPINION_KIND_TEXT = { dislike: "\u{1F615} \u4E0D\u559C\u6B22\u8FD9\u79CD\u5199\u6CD5", drop: "\u{1F5D1} \u8FD9\u7C7B\u5185\u5BB9\u4E0D\u9700\u8981", change: "\u270F\uFE0F \u8981\u6539\u6210" };
var OPINION_STATUS_TEXT = { pending: "\u5F85\u5904\u7406", sent: "AI \u4FEE\u8BA2\u4E2D", applied: "AI \u5DF2\u6539", revoked: "\u5DF2\u64A4\u9500" };
function GoldOpinionList(props) {
  ...
  if (list.length === 0) {
    return (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("p", { style: { margin: "0" } }, "\u{1F4CB} \u672C\u7A3F\u610F\u89C1\u5355\u8FD8\u7A7A\u7740\uFF1A\u8BFB\u4E0B\u9762\u7684\u7A3F\u5B50\u968F\u624B\u6807\u8BB0\uFF0C\u6216\u7528\u6700\u5E95\u4E0B\u7684\u300C\u7B3C\u7EDF\u63D0\u4E00\u6761\u300D\u3002")
    );
  }
  let seq = 0;
  const rows = list.map((o) => {
    if (o.status === "revoked") {
      return (0, import_react.createElement)(
        "div",
        { key: o.id, style: { ...S.card, opacity: 0.45, textDecoration: "line-through", marginBottom: "6px" } },
    ...
    return (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        ...
        (0, import_react.createElement)("strong", null, `#${seq}`),
        (0, import_react.createElement)("span", null, OPINION_KIND_TEXT[o.kind] ?? o.kind),
        (0, import_react.createElement)("span", { style: { opacity: 0.75, fontSize: "12px" } }, target),
        o.wish ? (0, import_react.createElement)("span", null, o.wish) : null,
        (0, import_react.createElement)(
          "span",
          { style: { marginLeft: "auto", fontSize: "12px", whiteSpace: "nowrap" } },
          OPINION_STATUS_TEXT[o.status] ?? o.status,
          " ",
          (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => onRevoke(o.id), disabled: busy }, "\u64A4\u9500")
        )
      )
    );
  });
  ...
  return (0, import_react.createElement)(
    "div",
    null,
    (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontWeight: 600 } }, `\u{1F4CB} \u672C\u7A3F\u610F\u89C1\u5355\uFF08${seq} \u6761\uFF09`),
    ...rows,
    onRevise !== void 0 ? (0, import_react.createElement)(
      "div",
      { style: { margin: "8px 0" } },
      (0, import_react.createElement)(
        "button",
        { style: S.bigBtn(true), onClick: onRevise, disabled: busy || pendingCount === 0 },
        pendingCount > 0 ? `\u{1F501} \u8BA9 AI \u7167\u8FD9\u4E9B\u6539\uFF08${pendingCount} \u6761\uFF09` : "\u{1F501} \u8BA9 AI \u7167\u8FD9\u4E9B\u6539"
      ),
      pendingCount === 0 ? (0, import_react.createElement)("span", { style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 } }, "\u5148\u6807\u8BB0\u81F3\u5C11\u4E00\u6761\u610F\u89C1\uFF08\u6BB5\u65C1\u4E09\u952E\u6216\u7B3C\u7EDF\u4FBF\u7B7E\uFF09") : null,
      (0, import_react.createElement)("p", { style: S.hint }, "\u53EA\u6539\u4F60\u6807\u8FC7\u7684\u5730\u65B9\uFF0C\u5176\u4F59\u539F\u6837\u4FDD\u7559")
    ) : null
  );
}
...
function GoldReader(props) {
  const { text, opinions, busy, onOpinion, readOnly, onRevokeOpinion = () => {
  } } = props;
  const [hover, setHover] = (0, import_react.useState)(null);
  const [formPara, setFormPara] = (0, import_react.useState)(null);
  const [wishText, setWishText] = (0, import_react.useState)("");
  const [wishError, setWishError] = (0, import_react.useState)(null);
  const [generalKind, setGeneralKind] = (0, import_react.useState)("change");
  const [generalText, setGeneralText] = (0, import_react.useState)("");
  const [generalError, setGeneralError] = (0, import_react.useState)(null);
  const [pulsePhase, setPulsePhase] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
  ...
  for (const o of opinions ?? []) {
    ...
    if (o.target != null && Number.isSafeInteger(o.target.para)) {
      ...
      arr.push(`#${seq} ${o.kind === "dislike" ? "\u{1F615}" : o.kind === "drop" ? "\u{1F5D1}" : "\u270F\uFE0F"}`);
  ...
  return (0, import_react.createElement)(
    ...
    !readOnly ? (0, import_react.createElement)(
      "p",
      { style: { margin: "0 0 8px", fontSize: "12px", opacity: 0.75 } },
    ...
    paras.map((para, idx) => {
      ...
      return (0, import_react.createElement)(
        ...
        (0, import_react.createElement)(
          ...
          String(n),
          marks.length > 0 ? (0, import_react.createElement)("span", { style: { display: "block" } }, marks.join(" ")) : null
        ),
        // 正文段落：纯流式 + markdown 最小渲染（标题/加粗/列表行）。
        (0, import_react.createElement)("p", { style: READER_PARA_STYLE }, ...renderInline(para)),
        formPara === n ? (0, import_react.createElement)(
          "div",
          ...
          (0, import_react.createElement)(
            ...
            (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: submitWish, disabled: busy }, "\u2705 \u8BB0\u4E0B\u8FD9\u6761"),
            (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => {
              setFormPara(null);
              setWishError(null);
            } }, "\u6536\u8D77"),
            wishError !== null ? (0, import_react.createElement)("span", { style: S.error }, wishError) : null
          )
        ) : null,
        ...
        !readOnly ? (0, import_react.createElement)(
          ...
          (() => {
            const activeOf = (kind) => (opinions ?? []).find((o) => o.status !== "revoked" && o.target != null && o.target.para === n && o.kind === kind);
            ...
            return [
              keyWith("\u{1F615}", "dislike", "\u8FD9\u79CD\u5199\u6CD5\u4E0D\u559C\u6B22", () => onOpinion("dislike", "", n, paragraphHint(para))),
              keyWith("\u{1F5D1}", "drop", "\u8FD9\u7C7B\u5185\u5BB9\u4E0D\u9700\u8981", () => onOpinion("drop", "", n, paragraphHint(para))),
              keyWith("\u270F\uFE0F", "change", "\u8981\u6539\u6210\uFF08\u5199\u4E00\u53E5\u8BDD\uFF09", () => {
                setFormPara(n);
                setWishText("");
              }, false)
            ];
    ...
    !readOnly ? (0, import_react.createElement)(
      "div",
      { style: { ...S.card, display: "flex", gap: "8px", alignItems: "center", flexWrap: "wrap" } },
      (0, import_react.createElement)("span", { style: { fontSize: "12px", opacity: 0.75 } }, "\u7B3C\u7EDF\u63D0\u4E00\u6761\uFF08\u4E0D\u6307\u54EA\u6BB5\u4E5F\u884C\uFF09\uFF1A"),
      ["dislike", "drop", "change"].map((k) => (0, import_react.createElement)("button", {
        key: k,
      ...
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: submitGeneral, disabled: busy }, "\u7B3C\u7EDF\u63D0\u4E00\u6761"),
      generalError !== null ? (0, import_react.createElement)("span", { style: S.error }, generalError) : null
    ) : null
  );
}
...
function GoldFinalize(props) {
  ...
  const [targetWords, setTargetWords] = (0, import_react.useState)("");
  ...
  const requestSuggestion = () => {
    ...
    }).catch((err) => setError(String(err instanceof Error ? err.message : err))).finally(() => setSuggesting(false));
  };
  ...
  return (0, import_react.createElement)(
    "div",
    { style: S.card },
    (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontWeight: 600 } }, "\u2705 \u6EE1\u610F\u4E86\u5C31\u5B9A\u7A3F\uFF08\u8FD9\u4E00\u7AE0\u5C31\u662F\u5168\u4E66\u7684\u6837\u677F\uFF09"),
    (0, import_react.createElement)(
      "div",
      { style: { margin: "6px 0" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px", fontSize: "12px", opacity: 0.8 } }, "\u6BCF\u7AE0\u5B57\u6570\uFF08\u6765\u81EA\u7AE0\u8282\u5B89\u6392\uFF0C\u53EF\u53EA\u8C03\u8FD9\u4E00\u7AE0\uFF09\uFF1A"),
      (meta.outline?.chapters ?? []).map((chapter, index) => (0, import_react.createElement)(
        "div",
        { key: index, style: { fontSize: "12px", margin: "2px 0", display: "flex", gap: "6px", alignItems: "baseline" } },
        ...
        chapter.volumeReason ? (0, import_react.createElement)("span", { style: { opacity: 0.5 } }, `\uFF08${chapter.volumeReason}\uFF09`) : null
      )),
      Number.isFinite(meta.targetWords) ? (0, import_react.createElement)("p", { style: { margin: "4px 0 0", fontSize: "12px", opacity: 0.6 } }, `\u515C\u5E95\u7EDF\u4E00\u503C\uFF1A${meta.targetWords} \u5B57\uFF08\u4EC5\u672A\u586B\u7AE0\u4F7F\u7528\uFF09`) : null
    ),
    (0, import_react.createElement)(
      "div",
      { style: { display: "flex", gap: "6px", alignItems: "center", flexWrap: "wrap" } },
      (0, import_react.createElement)("label", { style: S.label }, "\u515C\u5E95\u7EDF\u4E00\u5B57\u6570\uFF08\u53EF\u9009\uFF0C\u4EC5\u672A\u586B\u7AE0\u4F7F\u7528\uFF09"),
      (0, import_react.createElement)("input", {
      ...
      (0, import_react.createElement)(
        "button",
        { style: { ...S.bigBtn(true), padding: "6px 14px" }, onClick: requestSuggestion, disabled: suggesting || busy },
        suggesting ? "AI \u601D\u8003\u4E2D\u2026" : "\u2728 AI \u5EFA\u8BAE"
      )
    ),
    suggestion !== null ? (0, import_react.createElement)(
      "div",
      ...
      (suggestion.perChapter ?? []).length > 0 ? (0, import_react.createElement)(
        "div",
        null,
        (suggestion.perChapter ?? []).map((item) => (0, import_react.createElement)(
          "div",
    ...
    !wordsEmpty && !wordsOk ? (0, import_react.createElement)("p", { style: S.error }, "\u515C\u5E95\u5B57\u6570\u8BF7\u5728 500-50000 \u4E4B\u95F4\uFF0C\u6216\u7559\u7A7A\u53EA\u7528\u6BCF\u7AE0\u6E05\u5355") : null,
    error !== null ? (0, import_react.createElement)("p", { style: S.error }, `\u26A0\uFE0F ${error}`) : null,
    (0, import_react.createElement)(
      "div",
    ...
    (0, import_react.createElement)("p", { style: S.hint }, "\u4ECE\u5934\u91CD\u5199\u8FD9\u4E00\u7AE0\uFF1B\u4F60\u6807\u8FC7\u7684\u610F\u89C1\u4ECD\u4F1A\u5E26\u7ED9 AI \u5F53\u65B9\u5411"),
    confirming === "seal" ? (0, import_react.createElement)(
      "div",
      { style: { ...S.card, borderColor: "var(--dsw-accent, #4f6ef7)", marginTop: "8px" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px", fontWeight: 600 } }, "\u5B9A\u7A3F\u524D\u786E\u8BA4\uFF1A\u4E0B\u9762\u8FD9\u4E9B\u4F1A\u6C38\u4E45\u751F\u6548"),
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px", fontSize: "12px", opacity: 0.85 } }, "\u2460 \u4F60\u7684\u610F\u89C1\u8F6C\u6210\u300C\u98CE\u683C\u7EBF\u300D\uFF0C\u540E\u9762\u6BCF\u4E00\u7AE0\u90FD\u7167\u6B64\u6267\u884C\uFF1A"),
      live.map((o, i) => (0, import_react.createElement)(
        "p",
        { key: o.id, style: { margin: "0 2px 2px 12px", fontSize: "12px" } },
        `#${i + 1} ${OPINION_KIND_TEXT[o.kind] ?? o.kind}${o.wish ? `\uFF1A${o.wish}` : ""}`
      )),
      (0, import_react.createElement)("p", { style: { margin: "4px 0", fontSize: "12px", opacity: 0.85 } }, "\u2461 \u8FD9\u4E00\u7A3F\u51BB\u7ED3\u4E3A\u300C\u98CE\u683C\u6BCD\u7248\u300D\uFF0CAI \u94FA\u5168\u4E66\u65F6\u90FD\u62FF\u5B83\u5F53\u6837\u677F\u3002"),
      (0, import_react.createElement)(
        "div",
        { style: { display: "flex", gap: "8px", marginTop: "6px" } },
        (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: () => onApprove(true, targetToSend), disabled: busy || !wordsOk }, "\u786E\u8BA4\uFF0C\u5B9A\u7A3F"),
        (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => setConfirming(null) }, "\u518D\u60F3\u60F3")
      )
    ) : null,
    confirming === "rewrite" ? (0, import_react.createElement)(
      "div",
      { style: { ...S.card, borderColor: "var(--dsw-danger, #cf222e)", marginTop: "8px" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 6px" } }, "\u6574\u7A3F\u4E22\u5F03\u91CD\u5199\uFF1A\u8FD9\u4E00\u7A3F\u4F1A\u5B58\u6863\u7559\u5E95\uFF08\u4E0D\u4E22\uFF09\uFF0CAI \u4ECE\u5934\u518D\u5199\u4E00\u7248\u3002"),
      (0, import_react.createElement)(
        "div",
        { style: { display: "flex", gap: "8px" } },
        (0, import_react.createElement)("button", { style: { ...S.bigBtn(true), background: "transparent", color: "var(--dsw-danger, #cf222e)" }, onClick: () => onApprove(false, targetToSend), disabled: busy || !wordsOk }, "\u786E\u8BA4\u91CD\u5199"),
        (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => setConfirming(null) }, "\u518D\u60F3\u60F3")
      )
    ) : null
  );
...
function GoldTable(props) {
  ...
  const [view, setView] = (0, import_react.useState)({ tab: goldDraftVersion, mode: "read" });
  const [auditText, setAuditText] = (0, import_react.useState)(void 0);
  ...
  const load = (path) => {
    ...
    fetchText(path).then((t) => setTexts((prev) => ({ ...prev, [path]: t }))).catch((err) => setLoadError(String(err instanceof Error ? err.message : err)));
  };
  (0, import_react.useEffect)(() => {
    load(currentPath);
  ...
  const tabBtn = (v) => (0, import_react.createElement)("button", {
    key: v,
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, "\u{1F91D} \u6700\u4F73\u8303\u4F8B\u7AE0 \xB7 \u98CE\u683C\u8C08\u5224\u684C"),
      (0, import_react.createElement)("span", { style: { fontSize: "12px", opacity: 0.8 } }, auditBadge)
    ),
    goldDraftVersion > 1 ? (0, import_react.createElement)(
      "div",
      { style: { display: "flex", gap: "6px", flexWrap: "wrap", marginBottom: "6px" } },
      Array.from({ length: goldDraftVersion }, (_, i) => tabBtn(i + 1)),
      showTab === goldDraftVersion ? (0, import_react.createElement)(
        "button",
        { style: S.smallLink, onClick: () => setView({ tab: showTab, mode: view.mode === "compare" ? "read" : "compare" }) },
    ...
    loadError !== null ? (0, import_react.createElement)("p", { style: S.error }, `\u7A3F\u5B50\u6253\u5F00\u5931\u8D25\uFF1A${loadError}`) : null,
    (0, import_react.createElement)(
      "div",
      { style: { margin: "6px 0" } },
      showText === null ? (0, import_react.createElement)("p", { style: S.hint }, "\u52A0\u8F7D\u4E2D\u2026") : view.mode === "compare" && compareText !== null ? (0, import_react.createElement)(
        "div",
        null,
        (0, import_react.createElement)("p", { style: S.hint }, "\u60F3\u5728\u8FD9\u4E00\u7A3F\u4E0A\u7EE7\u7EED\u6311\u6BDB\u75C5\uFF1F\u70B9\u300C\u53EA\u770B\u8FD9\u4E00\u7A3F\u300D\u3002"),
        (0, import_react.createElement)(GoldCompare, {
          oldText: showTab === goldDraftVersion ? compareText : showText,
          newText: showTab === goldDraftVersion ? showText : compareText,
          opinions
        })
      ) : (0, import_react.createElement)(GoldReader, {
        text: showText,
        opinions,
        busy,
      ...
      showTab !== goldDraftVersion && view.mode === "read" ? (0, import_react.createElement)("p", { style: { fontSize: "12px", opacity: 0.7, margin: "4px 0" } }, "\u8FD9\u662F\u65E7\u7A3F\uFF0C\u53EA\u80FD\u56DE\u987E\uFF1B\u8981\u6311\u6BDB\u75C5\u8BF7\u56DE\u5230\u300C\u6700\u65B0\u300D\u90A3\u7A3F\u3002") : null
    ),
    (0, import_react.createElement)(GoldOpinionList, {
      opinions,
      busy,
      onRevoke: (id) => {
        void postAction({ action: "gold-opinion-revoke", id });
    ...
    (0, import_react.createElement)(GoldFinalize, { meta, opinions, busy, onApprove: (approved, targetWords) => {
...
function ActivityLine(props) {
  ...
  const content = aiActive ? "\u{1F916} AI \u56DE\u5408\u8FDB\u884C\u4E2D" : meta?.status === "running" ? (0, import_react.createElement)(
    "span",
    null,
  ...
  return (0, import_react.createElement)(
    ...
    aggText !== "" ? (0, import_react.createElement)("span", { style: { fontWeight: 600, color: "#0969da" } }, aggText) : null,
    content
  );
}
function InterruptNote(props) {
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)("span", { style: { flex: 1 } }, "\u{1F4A1} \u5DF2\u8BB0\u4E0B\uFF1B\u4E0D\u6253\u65AD\u6B63\u5728\u5199\u7684\u8FD9\u4E00\u7AE0\uFF0CAI \u5230\u4E0B\u4E2A\u505C\u9760\u70B9\u4F1A\u7167\u529E"),
    (0, import_react.createElement)("button", { style: S.smallLink, onClick: props.onClose }, "\u2715")
  );
}
...
function AutoFollowAwaitNote(props) {
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)("style", null, AUTO_FOLLOW_KEYFRAMES),
    (0, import_react.createElement)("span", { style: { flex: 1 } }, "\u26A1 AI \u5728\u7B49\u4F60\u62CD\u677F\uFF0C\u5DF2\u5207\u56DE\u73B0\u5728"),
    (0, import_react.createElement)("button", { style: S.smallLink, onClick: props.onClose }, "\u2715")
  );
}
function AutoFollowProgressNote(props) {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)("style", null, AUTO_FOLLOW_KEYFRAMES),
    (0, import_react.createElement)("span", { style: { flex: 1 } }, "\u25B6 AI \u6B63\u5728\u5E72\u6D3B--\u70B9\u6B64\u8DF3\u8FC7\u53BB"),
    (0, import_react.createElement)("button", {
      style: S.smallLink,
      onClick: (e) => {
        e.stopPropagation();
...
var DIFF_COLORS = { "\u57FA\u7840": "#1a7f37", "\u91CD\u70B9": "#9a6700", "\u96BE\u70B9": "#cf222e", "\u8FDB\u9636": "#8250df" };
var RE_EXPLORE_REASONS = ["\u6709\u7684\u6750\u6599\u6CA1\u8BFB\u5168", "\u77E5\u8BC6\u70B9\u6574\u7406\u5F97\u592A\u7C97", "\u7AE0\u8282\u5EFA\u8BAE\u4E0D\u5408\u7406", "\u91CD\u70B9\u96BE\u70B9\u5224\u65AD\u4E0D\u5BF9"];
function exploreReportBlocks(mdText) {
  const paras = splitParagraphs(mdText);
  const blocks = [];
  for (const para of paras) {
    blocks.push(
      /^#{1,2}\s+/.test(para) ? (0, import_react.createElement)("div", { key: blocks.length, style: { margin: "0 0 0.6em" } }, ...renderInline(para)) : (0, import_react.createElement)("p", { key: blocks.length, style: READER_PARA_STYLE }, ...renderInline(para))
    );
  }
  return blocks;
}
function ExploreConfirmCard(props) {
  ...
  const [showPoints, setShowPoints] = (0, import_react.useState)(false);
  const [showSections, setShowSections] = (0, import_react.useState)(false);
  const [rejecting, setRejecting] = (0, import_react.useState)(false);
  const [reasons, setReasons] = (0, import_react.useState)([]);
  const [rejectNote, setRejectNote] = (0, import_react.useState)("");
  const [km, setKm] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
    let alive = true;
    setKm(null);
    if (project === null || project === void 0) return void 0;
    fetch(`/textbook/file?session=${encodeURIComponent(session)}&project=${encodeURIComponent(project)}&path=${encodeURIComponent("work/knowledge-map.json")}`).then((res) => res.ok ? res.text() : Promise.reject(new Error(`HTTP ${res.status}`))).then((text) => {
  ...
  const [report, setReport] = (0, import_react.useState)(() => typeof reportText === "string" && reportText !== "" ? reportText : null);
  (0, import_react.useEffect)(() => {
    let alive = true;
    ...
    setReport(null);
    if (project === null || project === void 0) return void 0;
    fetch(`/textbook/file?session=${encodeURIComponent(session)}&project=${encodeURIComponent(project)}&path=${encodeURIComponent("work/explore.md")}`).then((res) => res.ok ? res.text() : Promise.reject(new Error(`HTTP ${res.status}`))).then((text) => {
  ...
  return (0, import_react.createElement)(
    "div",
    { style: S.focus },
    reportBlocks.length > 0 ? (0, import_react.createElement)(
      "div",
    ...
    (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, "\u{1F50D} \u6E90\u63A2\u67E5\u505A\u5B8C\u4E86\uFF01"),
    (0, import_react.createElement)(
      "p",
      { style: { margin: "6px 0" } },
      `AI \u5DF2\u901A\u8BFB\u4F60\u7684\u6559\u6750\uFF0C\u6574\u7406\u51FA\uFF1A\u6765\u6E90\u6750\u6599 ${sum.sources ?? 0} \u4EFD \xB7 \u77E5\u8BC6\u70B9 ${sum.knowledgePoints ?? 0} \u4E2A \xB7 \u5EFA\u8BAE\u5206 ${sum.chapterSuggestion ?? 0} \u7AE0\u3002`
    ),
    focus.length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { margin: "4px 0 8px", padding: "8px 10px", background: "var(--dsw-surface, #fff)", borderRadius: "8px", border: "1px solid var(--dsw-border, #d0d7de)" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px", fontSize: "12px", opacity: 0.8 } }, "AI \u5224\u65AD\u7684\u91CD\u70B9/\u96BE\u70B9\uFF1A"),
      focus.map((item, index) => (0, import_react.createElement)("div", { key: index, style: { fontSize: "12px", margin: "2px 0" } }, `\xB7 ${item}`))
    ) : null,
    chapters.length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { margin: "4px 0 8px", padding: "8px 10px", background: "var(--dsw-surface, #fff)", borderRadius: "8px", border: "1px solid var(--dsw-border, #d0d7de)" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px", fontSize: "12px", opacity: 0.8 } }, "\u{1F4DA} AI \u5EFA\u8BAE\u7684\u7AE0\u8282\u5B89\u6392\uFF08\u540E\u7EED\u53EF\u518D\u8C03\uFF09\uFF1A"),
      chapters.map(
        (chapter, index) => (0, import_react.createElement)(
          "div",
          { key: index, style: { fontSize: "12px", margin: "2px 0" } },
          `${index + 1}. ${chapter.title ?? ""}`,
          chapter.source !== void 0 && chapter.source !== "" && chapter.source !== null ? (0, import_react.createElement)("span", { style: { opacity: 0.6 } }, `\u3000\u2190 ${chapter.source}`) : null
        )
      )
    ) : null,
    kps.length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { margin: "4px 0 8px" } },
      (0, import_react.createElement)(
        "button",
      ...
      showPoints ? (0, import_react.createElement)(
        "div",
        { style: { marginTop: "6px", padding: "8px 10px", background: "var(--dsw-surface, #fff)", borderRadius: "8px", border: "1px solid var(--dsw-border, #d0d7de)" } },
        kps.map(
          (point, index) => (0, import_react.createElement)(
            "div",
            { key: index, style: { fontSize: "12px", margin: "2px 0" } },
            `\xB7 ${point.title ?? ""}`,
            point.difficulty !== void 0 && point.difficulty !== "" && point.difficulty !== null ? (0, import_react.createElement)("span", { style: { color: DIFF_COLORS[point.difficulty] ?? "#57606a" } }, `\uFF08${point.difficulty}\uFF09`) : null,
            point.source !== void 0 && point.source !== "" && point.source !== null ? (0, import_react.createElement)("span", { style: { opacity: 0.5 } }, ` ${point.source}`) : null
          )
        )
      ) : null
    ) : null,
    sections.length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { margin: "4px 0 8px" } },
      (0, import_react.createElement)(
        "button",
        { style: S.smallLink, onClick: () => setShowSections(!showSections) },
        showSections ? "\u25BE \u6536\u8D77\u6BCF\u672C\u6750\u6599\u91CC\u8BFB\u5230\u7684\u5C0F\u8282" : "\u25B8 \u6BCF\u672C\u6750\u6599\u91CC\u8BFB\u5230\u7684\u5C0F\u8282\uFF08\u70B9\u5F00\u770B\uFF09"
      ),
      showSections ? (0, import_react.createElement)(
        "div",
        { style: { marginTop: "6px", padding: "8px 10px", background: "var(--dsw-surface, #fff)", borderRadius: "8px", border: "1px solid var(--dsw-border, #d0d7de)" } },
        sections.map((material, index) => {
          ...
          return (0, import_react.createElement)(
            ...
            (0, import_react.createElement)("span", { style: { opacity: 0.8 } }, titles.join(" / ") || "\uFF08\u672A\u8BFB\u5230\u5C0F\u8282\u6807\u9898\uFF09")
          );
        })
      ) : null
    ) : null,
    ...
    rejecting ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "10px", borderTop: "1px dashed var(--dsw-border, #d0d7de)", paddingTop: "8px" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontWeight: 600 } }, "\u54EA\u91CC\u4E0D\u6EE1\u610F\uFF1F\uFF08\u70B9\u9009\u6216\u5199\u4E00\u53E5\uFF0C10 \u79D2\u5185\u641E\u5B9A\uFF09"),
      (0, import_react.createElement)(
        "div",
        { style: { margin: "6px 0" } },
        RE_EXPLORE_REASONS.map((reason) => (0, import_react.createElement)(
          "label",
          { key: reason, style: S.checkItem },
          (0, import_react.createElement)("input", { type: "checkbox", checked: reasons.includes(reason), onChange: () => toggleReason(reason) }),
          ` ${reason}`
      ...
      (0, import_react.createElement)(
        ...
        (0, import_react.createElement)("button", { style: { ...S.smallLink, textDecoration: "none" }, onClick: cancelReject }, "\u53D6\u6D88")
      )
    ) : (0, import_react.createElement)(
      "div",
      { style: { display: "flex", gap: "8px", flexWrap: "wrap" } },
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: () => onConfirm(true), disabled: busy }, "\u2705 \u6EE1\u610F\uFF0C\u7EE7\u7EED\u8BBE\u8BA1"),
      (0, import_react.createElement)("button", { style: { ...S.bigBtn(true), background: "transparent", color: "var(--dsw-danger, #cf222e)" }, onClick: () => setRejecting(true), disabled: busy }, "\u{1F501} \u8BA9 AI \u91CD\u505A"),
      (0, import_react.createElement)("button", { style: { ...S.smallLink, textDecoration: "none" }, onClick: onViewReport, disabled: busy }, "\u{1F440} \u770B\u5B8C\u6574\u62A5\u544A")
    )
  );
}
function OutlineConfirmCard(props) {
  ...
  const [goldPick, setGoldPick] = (0, import_react.useState)(() => {
  ...
  return (0, import_react.createElement)(
    "div",
    { style: S.focus },
    (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, "\u{1F4D0} \u7AE0\u8282\u5B89\u6392\u51FA\u6765\u4E86\uFF01"),
    (0, import_react.createElement)(
      "p",
      { style: { margin: "6px 0" } },
    ...
    (0, import_react.createElement)(
      ...
      chapters.map((chapter, index) => {
        ...
        return (0, import_react.createElement)(
          ...
          `${index + 1}. ${chapter.title ?? ""}`,
          chapter.outline !== void 0 && chapter.outline !== "" && chapter.outline !== null ? (0, import_react.createElement)("span", { style: { opacity: 0.6 } }, `\u3000${chapter.outline}`) : null,
          (0, import_react.createElement)(
            "div",
          ...
          pointsArr.length > 0 ? (0, import_react.createElement)("div", { style: { opacity: 0.6, margin: "1px 0 0" } }, `\u8986\u76D6\u77E5\u8BC6\u70B9 ${pointsArr.length} \u4E2A${points !== "" ? `\uFF1A${points}` : ""}`) : null,
          volumeReason !== "" ? (0, import_react.createElement)("div", { style: { opacity: 0.5, fontSize: "11px", margin: "1px 0 0" } }, `\u4F53\u91CF\u4F9D\u636E\uFF1A${volumeReason}`) : null
        );
      })
    ),
    (0, import_react.createElement)(
      "div",
      { style: { margin: "4px 0 10px", display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" } },
      (0, import_react.createElement)(
        "span",
        { style: { fontSize: "12px" } },
        `\u{1F4D0} AI \u5EFA\u8BAE\u7528\u7B2C ${safePick} \u7AE0\u5F53\u6837\u4F8B\u7AE0\uFF1A${goldReason !== "" ? goldReason : "\uFF08\u672A\u7ED9\u7406\u7531\uFF09"}`
      ),
      chapters.length > 1 ? (0, import_react.createElement)("select", {
        ...
        disabled: busy
      }, chapters.map((chapter, index) => (0, import_react.createElement)("option", { key: index, value: index + 1 }, `${index + 1}. ${chapter.title ?? ""}`))) : null,
      chapters.length > 1 ? (0, import_react.createElement)("span", { style: { fontSize: "11px", opacity: 0.6 } }, "\uFF08\u53EF\u6539\u9009\uFF09") : null
    ),
    rejecting ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "10px", borderTop: "1px dashed var(--dsw-border, #d0d7de)", paddingTop: "8px" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontWeight: 600 } }, "\u6539\u54EA\u91CC\uFF1F\u5199\u4E00\u53E5\uFF08\u6BD4\u5982\uFF1A\u7B2C3\u7AE0\u62C6\u6210\u4E24\u7AE0 / \u6BCF\u7AE0\u5B57\u6570\u592A\u591A\uFF09"),
      (0, import_react.createElement)("textarea", {
        style: S.textarea,
      ...
      "div",
      { style: { display: "flex", gap: "8px", flexWrap: "wrap" } },
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: () => onConfirm(true, note, safePick), disabled: busy }, "\u2705 \u901A\u8FC7\uFF0C\u5F00\u59CB\u5199\u8303\u4F8B\u7AE0"),
      (0, import_react.createElement)("button", { style: { ...S.bigBtn(true), background: "transparent", color: "var(--dsw-danger, #cf222e)" }, onClick: () => setRejecting(true), disabled: busy }, "\u{1F501} \u63D0\u6539\u8FDB\u65B9\u5411")
    )
  );
}
function chapterBadge(row, pendingReviews, doneSet, pipelineStage) {
  ...
  if (pipelineStage === "auditing") return { icon: "\u{1F50D}", text: "\u5BA1\u8BA1\u4E2D", tone: "#0969da" };
  if (pipelineStage === "audited") return { icon: "\u{1F50E}", text: "\u5BA1\u8BA1\u5B8C\u6210\uFF0C\u7B49 AI \u7EC8\u5BA1", tone: "#0969da" };
  if (pipelineStage === "finalizing") return { icon: "\u{1F441}", text: "AI \u7EC8\u5BA1\u4E2D", tone: "#57606a" };
  if (pipelineStage === "done") {
    return hasReview ? { icon: "\u{1F4DD}", text: "\u6709\u610F\u89C1\u5F85 AI \u4FEE\u8BA2", tone: "#cf222e" } : { icon: "\u{1F6E1}\uFE0F", text: "\u5199\u5B8C\xB7\u5BA1\u8FC7\xB7AI \u628A\u8FC7\u5173", tone: "#1a7f37" };
  }
  if (row.written && row.audited) return { icon: "\u{1F441}", text: "AI \u7EC8\u5BA1\u4E2D", tone: "#57606a" };
  if (row.written) return { icon: "\u{1F50D}", text: "\u5199\u597D\u4E86\uFF0C\u5BA1\u8BA1\u4E2D", tone: "#0969da" };
...
function ChaptersCard(props) {
  ...
  const [openChapter, setOpenChapter] = (0, import_react.useState)(() => Number.isSafeInteger(initialOpenChapter) && initialOpenChapter >= 1 ? initialOpenChapter : null);
  const [chapterText, setChapterText] = (0, import_react.useState)(null);
  const [chapterError, setChapterError] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
    let alive = true;
    setChapterText(null);
    ...
    fetch(`/textbook/file?session=${encodeURIComponent(session)}&project=${encodeURIComponent(project)}&path=${encodeURIComponent(rel)}`).then((res) => res.ok ? res.text() : Promise.reject(new Error(`HTTP ${res.status}`))).then((text) => {
      if (alive) setChapterText(text);
    }).catch((err) => {
      if (alive) setChapterError(String(err instanceof Error ? err.message : err));
    });
    return () => {
      alive = false;
    };
  ...
  const doneSet = (0, import_react.useMemo)(() => deriveDoneSet(events), [events]);
  ...
  return (0, import_react.createElement)(
    "div",
    { style: S.focus },
    reviewMode ? (0, import_react.createElement)(
      "div",
      { style: { margin: "0 0 10px", padding: "8px 10px", borderRadius: "8px", background: "var(--dsw-accent-soft, #eef2ff)" } },
      (0, import_react.createElement)("strong", null, "\u{1F4DA} \u5168\u90E8\u7AE0\u8282\u5199\u597D\u4E86\uFF0C\u8BF7\u4F60\u8FC7\u76EE"),
      (0, import_react.createElement)(
        "p",
        { style: { margin: "4px 0", fontSize: "12px", opacity: 0.8 } },
        "\u60F3\u7EC6\u770B\u70B9\u300C\u770B\u770B\u8FD9\u7AE0\u300D\uFF1B\u6709\u610F\u89C1\u76F4\u63A5\u5199\uFF0CAI \u7167\u6539\uFF1B\u90FD\u6EE1\u610F\u5C31\u4EA4\u5DE5\u5408\u5E76\u3002"
      ),
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: onApproveAll, disabled: busy }, "\u2705 \u90FD\u8FC7\u4E86\uFF0C\u4EA4\u5DE5")
    ) : null,
    (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, "\u{1F4DA} \u94FA\u7AE0 \xB7 \u7AE0\u8282\u6E05\u5355"),
    (0, import_react.createElement)(
      "p",
    ...
    progressDetail !== null && progressDetail !== void 0 && progressDetail !== "" ? (0, import_react.createElement)(
      "div",
      { style: { margin: "0 0 8px", padding: "6px 10px", borderRadius: "8px", background: "var(--dsw-accent-soft, #eef2ff)", fontSize: "12px" } },
    ...
    rows.map((row) => {
      ...
      return (0, import_react.createElement)(
        ...
        (0, import_react.createElement)(
          ...
          (0, import_react.createElement)("span", { style: { flex: 1, fontSize: "13px", fontWeight: 600 } }, `\u7B2C ${row.n} \u7AE0\u300A${row.title}\u300B`),
          !prepared ? (0, import_react.createElement)("span", { style: { fontSize: "12px", color: badge.tone } }, `${badge.icon} \u51C6\u5907\u4E2D`) : (0, import_react.createElement)("span", { style: { fontSize: "12px", color: badge.tone } }, `${badge.icon} ${badge.text}`)
        ),
        sourceIndex !== "" ? (0, import_react.createElement)("div", { style: { margin: "2px 0 0", fontSize: "11px", opacity: 0.6 } }, sourceIndex) : null,
        (0, import_react.createElement)(
          "div",
          { style: { marginTop: "6px", display: "flex", gap: "10px", alignItems: "center" } },
          (0, import_react.createElement)("button", {
            style: S.smallLink,
            onClick: () => {
              if (reviewMode) {
          ...
          prepared ? (0, import_react.createElement)("button", {
            style: S.smallLink,
            onClick: () => {
        ...
        open ? (0, import_react.createElement)(
          ...
          (0, import_react.createElement)("button", { style: { ...S.bigBtn(true), padding: "6px 14px" }, onClick: () => sendReview(row.n), disabled: busy || comment.trim() === "" }, "\u628A\u610F\u89C1\u4EA4\u7ED9 AI \u4FEE\u8BA2")
        ) : null,
        // F39：过目态内联展开——章正文 md 渲染（GoldReader 的段落流式排版 + renderInline），
        // 段落旁复用 GoldReader 段级三键（😕/🗑/✏️），意见走 gold-opinion 带 chapter 落 pendingReviews。
        chapterOpen ? (0, import_react.createElement)(
          "div",
          { style: { marginTop: "8px", borderTop: "1px dashed var(--dsw-border, #d0d7de)", paddingTop: "8px" } },
          chapterError !== null ? (0, import_react.createElement)("p", { style: S.error }, `\u6253\u5F00\u5931\u8D25\uFF1A${chapterError}`) : shownText === null ? (0, import_react.createElement)("p", { style: S.hint }, "\u52A0\u8F7D\u4E2D\u2026") : (0, import_react.createElement)(
            "div",
            null,
            (0, import_react.createElement)(
              "p",
...
function ProcessMapRail(props) {
  ...
  return (0, import_react.createElement)(
    "div",
    { style: { width: "220px", flexShrink: 0, borderRight: "1px solid var(--dsw-border, #d0d7de)", padding: "8px", display: "flex", flexDirection: "column", overflow: "hidden" } },
    (0, import_react.createElement)(
      "div",
      { style: { flex: 1, minHeight: 0, overflowY: "auto" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontSize: "12px", opacity: 0.7 } }, "\u{1F5FA} \u8FC7\u7A0B\u5730\u56FE\uFF08\u70B9\u4EFB\u610F\u4E00\u6B65\u56DE\u770B/\u5B9A\u70B9\u4FEE\u6539\uFF09"),
      ...(segments ?? []).map(row),
      (0, import_react.createElement)("p", { style: { margin: "8px 0 0", fontSize: "11px", opacity: 0.55 } }, "\u26A1=\u5728\u7B49\u4F60 \xB7 \u25B6=\u6B63\u5728\u505A \xB7 \xB7=\u5DF2\u5B8C\u6210")
    ),
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        ...
        (0, import_react.createElement)("span", { style: { fontSize: "16px" } }, "\u{1F4DA}"),
        (0, import_react.createElement)("strong", { style: { fontSize: "13px" } }, "\u3010\u7834\u5377\u3011"),
        (0, import_react.createElement)("span", { style: { fontSize: "10px", background: "rgba(255,255,255,0.22)", borderRadius: "4px", padding: "0 5px", lineHeight: "15px" } }, "\u884D\u751F\u9879\u76EE")
      ),
      (0, import_react.createElement)("div", null, "\u628A\u9020\u597D\u7684\u4E66\u4EA4\u7ED9\u3010\u7834\u5377\u3011"),
      (0, import_react.createElement)("div", null, "3A \u6C89\u6D78\u611F \xB7 3 \u500D\u5B66\u4E60\u6548\u7387"),
      (0, import_react.createElement)(
        "div",
...
function HistoryBrowser(props) {
  ...
  return (0, import_react.createElement)(
    "div",
    { style: S.focus },
    (0, import_react.createElement)("strong", { style: { fontSize: "14px" } }, `\u{1F5C2} \u56DE\u770B\uFF1A${segment.label ?? segment.key}`),
    (0, import_react.createElement)(
      "p",
    ...
    (segment.artifacts ?? []).length > 0 ? (0, import_react.createElement)(
      "div",
      { style: { margin: "4px 0 8px" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 4px", fontSize: "12px", opacity: 0.8 } }, "\u8FD9\u4E00\u6B65\u7684\u4EA7\u7269\uFF1A"),
      ...(segment.artifacts ?? []).map((rel) => (0, import_react.createElement)("button", {
        key: rel,
        style: { ...S.smallLink, display: "block", margin: "2px 0" },
        onClick: () => props.onView(rel),
        title: "\u70B9\u5F00\u770B\u5185\u5BB9"
      }, `\u{1F4C4} ${rel}`))
    ) : (0, import_react.createElement)("p", { style: { margin: "4px 0 8px", fontSize: "12px", opacity: 0.6 } }, "\u8FD9\u4E00\u6B65\u6CA1\u6709\u7559\u4EA7\u7269\u3002"),
    segment.key !== "chapters-review" && segment.canDeepModify === true ? confirming ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "8px", borderTop: "1px dashed var(--dsw-border, #d0d7de)", paddingTop: "8px" } },
      (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontWeight: 600 } }, `\u270D\uFE0F \u5B9A\u70B9\u4FEE\u6539\u300C${segment.label}\u300D`),
      (0, import_react.createElement)("p", { style: { margin: "0 0 6px", fontSize: "12px", color: "var(--dsw-danger, #cf222e)" } }, `\u5F71\u54CD\u9884\u544A\uFF1A${downstreamText}\u3002`),
      (0, import_react.createElement)(
        "p",
        { style: { margin: "0 0 6px", fontSize: "12px", opacity: 0.75 } },
      ...
      style: { ...S.bigBtn(true), background: "transparent", color: "var(--dsw-danger, #cf222e)" },
      onClick: () => setConfirming(true),
      disabled: busy
    }, "\u270D\uFE0F \u5B9A\u70B9\u4FEE\u6539\u8FD9\u4E00\u6B65") : null,
    undoable ? (0, import_react.createElement)("button", {
      style: { ...S.smallLink, textDecoration: "none", marginTop: "8px" },
      disabled: busy,
      onClick: onDeepUndo
    }, "\u21A9\uFE0F \u64A4\u9500\u521A\u624D\u7684\u5B9A\u70B9\u4FEE\u6539\uFF0810 \u5206\u949F\u5185\uFF09") : null,
    (0, import_react.createElement)(
      "p",
...
function foldKnowledgeMap(text) {
  ...
  if (kps.length > 0) {
    ...
    for (const point of kps) {
      ...
      lines.push(`\xB7 ${title}${diff !== "" ? `\uFF08${diff}\uFF09` : ""}${src !== "" ? ` ${src}` : ""}`);
    }
    lines.push("");
  }
...
function FileViewer(props) {
  ...
  return (0, import_react.createElement)(
    "div",
    { style: { marginTop: "8px", border: "1px solid var(--dsw-border, #d0d7de)", borderRadius: "8px", padding: "10px" } },
    (0, import_react.createElement)(
      "div",
      { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
      (0, import_react.createElement)("strong", { style: { fontSize: "13px" } }, `\u{1F4C4} ${viewing.label}`),
      (0, import_react.createElement)("button", { style: S.smallLink, onClick: onClose }, "\u2715 \u6536\u8D77")
    ),
...
function BrowseSection(props) {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)("button", { style: S.smallLink, onClick: onBack }, "\u23EA \u56DE\u5230\u73B0\u5728"),
    (0, import_react.createElement)(HistoryBrowser, { segment, meta, busy, onView, onDeepModify, onDeepUndo }),
    viewing !== null && viewText !== null ? (0, import_react.createElement)(FileViewer, { viewing, viewText, onClose: onCloseView }) : null
  );
}
...
function TopBar(props) {
  ...
  return (0, import_react.createElement)(
    "div",
    { style: { display: "flex", alignItems: "center", gap: "8px", padding: "6px 8px", borderBottom: "1px solid var(--dsw-border, #d0d7de)", flexWrap: "wrap" } },
    (0, import_react.createElement)("strong", null, `\u300A${meta?.name ?? ""}\u300B`),
    (0, import_react.createElement)("span", { style: { fontSize: "12px", opacity: 0.75 } }, `\u4E00\u8D77\u505A\u5230\uFF1A${PHASES.find((x) => x.n === meta?.phase)?.label ?? ""}`),
    (0, import_react.createElement)("span", { style: { flex: 1 } }),
    styleCount > 0 ? (0, import_react.createElement)("button", { style: S.smallLink, onClick: openStylePanel, title: "\u4F60\u7684\u98CE\u683C\u610F\u89C1\u6E05\u5355\uFF08AI \u5199\u6BCF\u4E00\u7AE0\u90FD\u4F1A\u7167\u7740\u529E\uFF09" }, `\u{1F3A8} \u98CE\u683C\u7EBF(${styleCount})`) : null,
    pendingCount > 0 ? (0, import_react.createElement)("button", { style: S.smallLink, onClick: openIntervene, title: "\u7559\u8A00\u7A0D\u540E\u5904\u7406\uFF1A\u4E0D\u6253\u65AD AI\uFF0C\u5B83\u5230\u4E0B\u4E2A\u505C\u9760\u70B9\u4F1A\u770B" }, `\u{1F4EE} \u7559\u8A00(${pendingCount})`) : null,
    meta?.pause != null ? (0, import_react.createElement)("button", { style: { ...S.smallLink, color: "#1a7f37" }, onClick: resume, title: "\u7EE7\u7EED\u4ECE\u65AD\u70B9\u63A5\u7740\u5199" }, "\u25B6 \u5DF2\u6682\u505C\xB7\u70B9\u7EE7\u7EED") : (0, import_react.createElement)("button", { style: S.smallLink, onClick: pause, title: "\u6682\u505C\uFF1A\u8FD9\u6B21\u5148\u505C\u4E0B\u624B\u91CC\u7684\u6D3B\uFF0C\u542C\u6211\u7684\uFF08\u5305\u62EC\u5C0F\u52A9\u624B\uFF09" }, "\u23F8 \u6682\u505C")
  );
}
function StylePanel(props) {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("strong", { style: { fontSize: "13px" } }, `\u{1F3A8} \u4F60\u7684\u98CE\u683C\u7EBF\uFF08${list.length} \u6761\uFF1AAI \u5199\u6BCF\u4E00\u7AE0\u90FD\u7167\u7740\u529E\uFF09`),
      (0, import_react.createElement)("button", { style: S.smallLink, onClick: onClose }, "\u2715 \u6536\u8D77")
    ),
    list.length === 0 ? (0, import_react.createElement)("p", { style: { margin: "6px 0 0", fontSize: "12px", opacity: 0.7 } }, "\u8FD8\u6CA1\u6709\u98CE\u683C\u610F\u89C1\uFF1B\u5728\u5BF9\u8BDD\u91CC\u8DDF AI \u63D0\u8981\u6C42\uFF0C\u5B83\u4F1A\u8BB0\u6210\u98CE\u683C\u7EBF\u3002") : list.map((note, index) => (0, import_react.createElement)(
      "div",
      { key: note.id, style: { margin: "6px 0", fontSize: "13px", lineHeight: 1.55 } },
      (0, import_react.createElement)("span", { style: { fontWeight: 600 } }, `#${index + 1}`),
      ` ${note.text ?? ""}`,
      note.note != null && note.note !== "" ? (0, import_react.createElement)("span", { style: { opacity: 0.6, fontSize: "12px" } }, `\uFF08${note.note}\uFF09`) : null
    ))
  );
}
function IntervenePanel(props) {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      "div",
      { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: "8px" } },
      (0, import_react.createElement)("strong", { style: { fontSize: "13px" } }, `\u{1F4EE} \u4F60\u7684\u7559\u8A00\uFF08${list.length} \u6761\u5F85\u5904\u7406\uFF09`),
      (0, import_react.createElement)("button", { style: S.smallLink, onClick: onClose }, "\u2715 \u6536\u8D77")
    ),
    list.length === 0 ? (0, import_react.createElement)("p", { style: { margin: "6px 0 0", fontSize: "12px", opacity: 0.7 } }, "\u6CA1\u6709\u5F85\u5904\u7406\u7684\u7559\u8A00\u3002") : list.map((item) => (0, import_react.createElement)(
      "div",
      { key: item.id, style: { margin: "6px 0", fontSize: "13px", lineHeight: 1.55 } },
      (0, import_react.createElement)("span", { style: { opacity: 0.6, fontSize: "12px" } }, formatTime(item.at)),
      item.target != null && item.target !== "" ? (0, import_react.createElement)("span", { style: { opacity: 0.7, fontSize: "12px", marginLeft: "6px" } }, `\uFF08${item.target}\uFF09`) : null,
      (0, import_react.createElement)("div", null, item.text ?? ""),
      (0, import_react.createElement)("p", { style: { margin: "2px 0 0", fontSize: "12px", opacity: 0.6 } }, "AI \u5230\u4E0B\u4E2A\u505C\u9760\u70B9\u4F1A\u770B\u5230\u5E76\u5904\u7406\uFF0C\u4E0D\u6253\u65AD\u5B83\u624B\u91CC\u7684\u6D3B\u3002")
    ))
  );
}
function PatternPanel(props) {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      "div",
      { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: "8px" } },
      (0, import_react.createElement)("strong", { style: { fontSize: "13px" } }, "\u{1F9E9} \u81EA\u5B9A\u4E49\u6A21\u5F0F\u5E93"),
      (0, import_react.createElement)("button", { style: S.smallLink, onClick: onClose }, "\u2715 \u6536\u8D77")
    ),
    (0, import_react.createElement)(
      "p",
      { style: { margin: "6px 0", fontSize: "12px", opacity: 0.75, lineHeight: 1.6 } },
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("button", { style: S.bigBtn(true), disabled: busy || text.trim() === "", onClick: () => {
        onAnalyze(text.trim());
        setText("");
      } }, "\u{1F916} \u8BA9 AI \u5206\u6790\u5E76\u52A0\u5165\u6A21\u5F0F\u5E93"),
      busy ? (0, import_react.createElement)("span", { style: { fontSize: "12px", opacity: 0.7 } }, "AI \u5206\u6790\u4E2D\u2026") : null
    ),
    result !== null ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "8px", padding: "8px 10px", borderRadius: "8px", background: "var(--dsw-success-soft, #dafbe1)", fontSize: "12px", lineHeight: 1.6 } },
      (0, import_react.createElement)("strong", null, `\u2705 \u5DF2\u52A0\u5165\u6A21\u5F0F\u5E93\uFF1A${result.name ?? ""}`),
      result.problem != null && result.problem !== "" ? (0, import_react.createElement)("p", { style: { margin: "4px 0 0" } }, `\u89E3\u51B3\uFF1A${result.problem}`) : null,
      result.blocks != null && result.blocks !== "" ? (0, import_react.createElement)("p", { style: { margin: "2px 0 0" } }, `\u843D\u5730\uFF1A${result.blocks}`) : null
    ) : null,
    (0, import_react.createElement)(
      "p",
    ...
    list.map((p, index) => (0, import_react.createElement)(
      "div",
      { key: p.file ?? index, style: { margin: "3px 0", fontSize: "12px", lineHeight: 1.5 } },
...
function MineruTokenCard(props) {
  ...
  if (mineruSet === false) {
    return (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("strong", { style: { color: "var(--dsw-danger, #cf222e)" } }, "\u{1F511} \u8FD8\u5DEE\u4E00\u6B65\uFF1AMinerU Token"),
      (0, import_react.createElement)("p", { style: { margin: "4px 0" } }, "PDF \u8F6C\u6362\u9700\u8981 MinerU \u7684\u514D\u8D39 Token\uFF08mineru.net \u7533\u8BF7\uFF09\u3002\u586B\u5728\u8FD9\u91CC\u5373\u53EF\uFF1A"),
      (0, import_react.createElement)("input", { style: S.input, placeholder: "\u7C98\u8D34 MinerU Token", value: mineruToken, onChange: onTokenChange }),
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: onSave, disabled: busy }, "\u4FDD\u5B58 Token")
    );
  }
  return (0, import_react.createElement)(
    "div",
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("strong", {}, "\u2705 MinerU Token \u5DF2\u8BBE\u7F6E\uFF08\u2022\u2022\u2022\u2022\uFF09"),
      (0, import_react.createElement)("button", { style: S.smallLink, onClick: onToggleReset }, "\u91CD\u65B0\u8BBE\u7F6E")
    ),
    resetOpen ? (0, import_react.createElement)(
      "div",
      { style: { marginTop: "6px" } },
      (0, import_react.createElement)("p", { style: { margin: "4px 0" } }, "\u586B\u65B0\u7684 Token \u5373\u53EF\u8986\u76D6\u65E7\u7684\uFF1A"),
      (0, import_react.createElement)("input", { style: S.input, placeholder: "\u7C98\u8D34\u65B0\u7684 MinerU Token", value: mineruToken, onChange: onTokenChange }),
      (0, import_react.createElement)("button", { style: S.bigBtn(true), onClick: onSave, disabled: busy }, "\u4FDD\u5B58\u65B0 Token")
    ) : null
  );
}
function WorkbenchView(props) {
  ...
  const [mineruSet, setMineruSet] = (0, import_react.useState)(true);
  const [mineruToken, setMineruToken] = (0, import_react.useState)("");
  const [mineruResetOpen, setMineruResetOpen] = (0, import_react.useState)(false);
  const [preview, setPreview] = (0, import_react.useState)(null);
  const [bookDir, setBookDir] = (0, import_react.useState)(null);
  const [workFiles, setWorkFiles] = (0, import_react.useState)([]);
  const [pendingStageView, setPendingStageView] = (0, import_react.useState)(null);
  const [pendingGateView, setPendingGateView] = (0, import_react.useState)(null);
  const [pendingReviews, setPendingReviews] = (0, import_react.useState)([]);
  const [exploreSummary, setExploreSummary] = (0, import_react.useState)(null);
  const [chapterStatus, setChapterStatus] = (0, import_react.useState)([]);
  const [goldDrafts, setGoldDrafts] = (0, import_react.useState)([]);
  const [goldDraftVersion, setGoldDraftVersion] = (0, import_react.useState)(1);
  const [viewing, setViewing] = (0, import_react.useState)(null);
  const [viewText, setViewText] = (0, import_react.useState)(null);
  const [gateOpen, setGateOpen] = (0, import_react.useState)(null);
  const [showMaterials, setShowMaterials] = (0, import_react.useState)(false);
  ...
  const [patternList, setPatternList] = (0, import_react.useState)([]);
  const [deskHeight, setDeskHeight] = (0, import_react.useState)(220);
  const [deskCollapsed, setDeskCollapsed] = (0, import_react.useState)(true);
  const deskRef = (0, import_react.useRef)(null);
  const deskLiveRef = (0, import_react.useRef)(null);
  const rootRef = (0, import_react.useRef)(null);
  const [rootH, setRootH] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
  ...
  const [processSegs, setProcessSegs] = (0, import_react.useState)([]);
  const [processSubagents, setProcessSubagents] = (0, import_react.useState)({ running: 0, inactive: 0 });
  ...
  const lastSeqRef = (0, import_react.useRef)(-1);
  ...
  const requestSuggest = async (hintText) => {
    ...
    try {
      const json = await fetchJson("/textbook/action", {
        method: "POST",
        headers: { "Content-Type": "application/json", Accept: "application/json" },
        body: JSON.stringify({ action: "wizard-suggest", session: sessionRef.current, hint: hintText || void 0 })
      });
  ...
  const deleteBook = (id) => {
    ...
    }).then((json) => setProjects(json.projects ?? [])).catch((err) => setError(String(err instanceof Error ? err.message : err))).finally(() => setBusy(false));
  };
  ...
  const togglePreview = () => {
    ...
    void fetch(`/textbook/file?${sess()}&project=${encodeURIComponent(activeRef.current)}&path=work/book.md`).then((res) => res.text()).then((text) => setPreview(text)).catch((err) => setError(String(err instanceof Error ? err.message : err)));
  };
  ...
  const progressDetail = progressEvent !== void 0 ? `${progressEvent.data?.label ?? ""}${progressEvent.data?.detail ? `\uFF1A${progressEvent.data.detail}` : ""}` : "";
  const STAGE_HUMAN = { explore: "\u6E90\u63A2\u67E5", outline: "\u7AE0\u8282\u9AA8\u67B6", gold: "\u6700\u4F73\u8303\u4F8B\u7AE0", chapters: "\u94FA\u7AE0", merge: "\u5408\u5E76\u6210\u4E66", final: "\u6700\u540E\u68C0\u67E5" };
  const pendingStageLabel = pendingStageView === "gate" ? `\u8BBE\u8BA1\u63D0\u6848\xB7\u7B2C ${pendingGateView ?? "?"} \u5173` : STAGE_HUMAN[pendingStageView] ?? "";
  const humanTurn = meta !== null && (meta.status === "awaiting-explore" || meta.status === "awaiting-outline" || meta.status === "awaiting-gold" || meta.status === "awaiting-chapters-review" || gate !== null && gate.status === "awaiting" || meta.phase === 1 && gate === null);
  ...
  if (sessionPreset !== null && sessionPreset !== "textbook") {
    return (0, import_react.createElement)(
      "div",
      { style: S.container },
      (0, import_react.createElement)("p", { style: S.title }, "\u9020\u4E66\u5DE5\u4F5C\u53F0"),
      (0, import_react.createElement)(
        "div",
        { style: S.card },
        (0, import_react.createElement)("p", { style: { margin: "0 0 6px" } }, "\u672C\u4F1A\u8BDD\u4E0D\u662F\u300C\u9020\u4E66\u6A21\u5F0F\u300D\uFF0C\u5DE5\u4F5C\u53F0\u4E0D\u5728\u8FD9\u91CC\u663E\u793A\u3002"),
        (0, import_react.createElement)("p", { style: { margin: "0", opacity: 0.8 } }, "\u4F7F\u7528\u65B9\u5F0F\uFF1A\u65B0\u5EFA\u4F1A\u8BDD\u65F6\uFF0C\u5728\u6A21\u5F0F\u91CC\u9009\u62E9\u300C\u9020\u4E66\u6A21\u5F0F\u300D\uFF0C\u5DE5\u4F5C\u53F0\u5C31\u4F1A\u51FA\u73B0\u5728\u90A3\u4E2A\u4F1A\u8BDD\u91CC\u3002")
      )
    );
  }
  const topBar = meta !== null && !loading ? (0, import_react.createElement)(TopBar, { meta, openStylePanel, openIntervene, pause, resume }) : null;
  const simpleContent = (0, import_react.createElement)(
    "div",
    { style: S.container },
    (0, import_react.createElement)("p", { style: S.title }, "\u9020\u4E66\u5DE5\u4F5C\u53F0"),
    (0, import_react.createElement)("p", { style: S.hint }, "\u672C\u4F1A\u8BDD\u72EC\u7ACB\u4F7F\u7528\uFF0C\u4E00\u4E2A\u4F1A\u8BDD\u53EA\u9020\u4E00\u672C\u4E66\u3002\u4E3B AI \u4EB2\u624B\u63A8\u8FDB\u6D41\u6C34\u7EBF\uFF0C\u8F6E\u5230\u4F60\u8981\u62CD\u677F/\u786E\u8BA4\u65F6\u4EAE\u8D77 \u26A1\uFF1B\u6BCF\u4E2A\u62CD\u677F\u70B9\u90FD\u81EA\u52A8\u5B58\u6863\uFF0C\u968F\u65F6\u80FD\u6539\u3002"),
    (0, import_react.createElement)(MineruTokenCard, {
      mineruSet,
      mineruToken,
      busy,
    ...
    error !== null ? (0, import_react.createElement)("p", { style: S.error }, `\u26A0\uFE0F ${error}`) : null,
    loading ? (0, import_react.createElement)("p", { style: S.hint }, "\u52A0\u8F7D\u4E2D\u2026") : showWizardForm ? (0, import_react.createElement)(WizardCard, {
      onCreate: createBook,
      onCreateDemo: () => {
    ...
    }) : (0, import_react.createElement)("p", { style: S.hint }, '\u8FD8\u6CA1\u6709\u4E66\u9879\u76EE\uFF0C\u70B9"\uFF0B \u65B0\u5EFA\u4E66"\u5F00\u59CB\u3002')
  );
  const projectView = () => (0, import_react.createElement)(
    "div",
    { style: { display: "flex", flex: 1, minHeight: 0, overflow: "hidden" } },
    // 左：过程地图栏（Task 15 三区骨架 P3；点任意段 -> 焦点区切浏览视图）。
    (0, import_react.createElement)(ProcessMapRail, {
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        "div",
        { style: { position: "relative", flex: 1, minHeight: 0, overflowY: "auto", padding: "12px 16px" } },
        // 自动跟随横幅（F5 方案 A）：等拍板强制回「现在」（6 秒自清）；浏览历史时 AI 有新进展（点击清浏览回现在）。
        awaitBanner ? (0, import_react.createElement)(AutoFollowAwaitNote, { onClose: () => setAwaitBanner(false) }) : null,
        progressBanner && browsing !== null ? (0, import_react.createElement)(AutoFollowProgressNote, {
          onJump: () => {
            setBrowsing(null);
            setProgressBanner(false);
          },
        ...
        noteToast ? (0, import_react.createElement)(InterruptNote, { onClose: () => setNoteToast(false) }) : null,
        // 业务头（原 workbenchContent 头部迁入焦点区顶）：书名/取消书、MinerU、错误。
        (0, import_react.createElement)(
          "div",
          { style: { display: "flex", gap: "10px", alignItems: "center", marginBottom: "10px" } },
          (0, import_react.createElement)("strong", { style: { fontSize: "15px" } }, `\u{1F4D6} ${meta.name ?? activeId}`),
          deletingId === activeId ? (0, import_react.createElement)("button", {
            style: { ...S.smallLink, color: "var(--dsw-danger, #cf222e)" },
            onClick: () => deleteBook(activeId),
            disabled: busy
          }, "\u786E\u8BA4\u53D6\u6D88\u8FD9\u672C\u4E66\uFF08\u8FDB\u56DE\u6536\u7AD9\uFF09") : (0, import_react.createElement)("button", {
            style: S.smallLink,
        ...
        mineruSet === false ? (0, import_react.createElement)(MineruTokenCard, {
          mineruSet,
          mineruToken,
          busy,
          onTokenChange: (e) => setMineruToken(e.target.value),
        ...
        browsing != null ? (0, import_react.createElement)(BrowseSection, {
        ...
        showStylePanel ? (0, import_react.createElement)(StylePanel, { notes: styleNotes, onClose: () => setShowStylePanel(false) }) : null,
        showIntervenePanel ? (0, import_react.createElement)(IntervenePanel, { items: pendingIvs, onClose: () => setShowIntervenePanel(false) }) : null,
        // 🧩 自定义模式库面板（2026-08-21）：粘贴描述 → AI 分析成「模式卡」加入本书。
        patternOpen ? (0, import_react.createElement)(PatternPanel, {
        ...
        mainProgressVisible(browsing) ? (0, import_react.createElement)(PhaseBar, {
          phase: meta.phase ?? 1,
          gate,
          status: meta.status,
          humanTurn,
        ...
        (0, import_react.createElement)(StatusStrip, { meta, gate, pendingStage: pendingStageView, progressDetail, metaLabel: pendingStageLabel }),
        // 主 AI 活性行（F17）：常驻一行——AI 回合进行中 / 账面 N 分钟没动静[戳一下 AI] / 等你拍板。
        (0, import_react.createElement)(ActivityLine, {
          meta,
          aiActive: partialActive || meta?.status === "running" && Date.now() - (meta.updatedAt ?? 0) < 3 * 60 * 1e3,
          onNudge: () => {
            void postAction({ action: "nudge", text: "\u8D26\u9762\u6709\u4E00\u4F1A\u6CA1\u52A8\u4E86\uFF0C\u8BF7\u67E5\u72B6\u6001\u7EE7\u7EED\u63A8\u8FDB" });
          },
          subagents: processSubagents
        }),
        bookDir !== null ? (0, import_react.createElement)(
          "p",
          { style: { margin: "6px 0 0", fontSize: "12px", opacity: 0.6, wordBreak: "break-all" } },
          `\u{1F4C1} \u4E66\u6587\u4EF6\u5939\uFF1A${bookDir}`
        ) : null,
        gate !== null && gate.status === "awaiting" ? (0, import_react.createElement)(GatePanel, { gate, onDecide: decide, onRollback: rollback, busy, error: null, onAddPattern: analyzePattern }) : meta.status === "awaiting-explore" ? (0, import_react.createElement)(ExploreConfirmCard, {
          meta,
          exploreSummary,
          project: activeId,
          ...
          busy
        }) : meta.status === "awaiting-outline" ? (0, import_react.createElement)(OutlineConfirmCard, {
          meta,
          busy,
          onConfirm: confirmOutline
        }) : meta.status === "awaiting-gold" ? (0, import_react.createElement)(GoldTable, {
          meta,
          busy,
          goldDrafts,
          goldDraftVersion,
          ...
          fetchText: (path) => fetch(`/textbook/file?${sess()}&project=${encodeURIComponent(activeRef.current)}&path=${encodeURIComponent(path)}`).then((res) => {
            if (!res.ok) throw new Error(`HTTP ${res.status}`);
            return res.text();
          })
        }) : meta.status === "delivered" ? (0, import_react.createElement)(DeliveryCard, {
          project: activeId,
          session: sessionRef.current,
          checks,
        ...
        }) : meta.phase === 5 && meta.demo !== true ? (0, import_react.createElement)(ChaptersCard, {
          meta,
          chapterStatus,
          pendingReviews,
          progressDetail,
          ...
          onApproveAll: () => {
            void postAction({ action: "chapters-review-confirm", approved: true });
          },
          ...
          postAction
          // F39 过目态内联展开/段级三键
        }) : meta.phase === 1 ? (0, import_react.createElement)(UploadArea, {
          ...
          busy
        }) : (0, import_react.createElement)(StatusCard, {
          meta,
          lastEvent,
          events,
        ...
        (0, import_react.createElement)(
          ...
          (0, import_react.createElement)(
            "button",
            { style: S.smallLink, onClick: () => setShowHistory(!showHistory) },
        ...
        showHistory ? events.map((event) => {
          ...
          return (0, import_react.createElement)(
            ...
            (0, import_react.createElement)(
              "div",
              null,
              (0, import_react.createElement)("span", null, cardIcon(event)),
              " ",
              (0, import_react.createElement)("strong", null, cardText(event)),
              product !== null ? (0, import_react.createElement)(
                "span",
                { style: { marginLeft: "8px", fontSize: "12px", color: "var(--dsw-accent, #4f6ef7)" } },
                viewingThis ? "\u{1F441}\uFE0F \u67E5\u770B\u4E2D" : "\u{1F4C4} \u67E5\u770B\u7ED3\u679C"
              ) : null,
              (0, import_react.createElement)("span", { style: { float: "right", opacity: 0.6, fontSize: "12px" } }, formatTime(event.time))
            ),
            isGate ? detailOpen ? (0, import_react.createElement)(
              "div",
              { style: { marginTop: "6px", fontSize: "12px", opacity: 0.9 } },
              (0, import_react.createElement)("p", { style: { margin: "0 0 4px" } }, event.data?.summary ?? ""),
              (event.data?.detail ?? "") !== "" ? (0, import_react.createElement)("pre", { style: { whiteSpace: "pre-wrap", wordBreak: "break-word", background: "var(--dsw-surface, #fff)", borderRadius: "6px", padding: "8px", fontSize: "12px", margin: "4px 0 0" } }, event.data.detail) : null
            ) : (event.data?.summary ?? "") !== "" ? (0, import_react.createElement)("div", { style: { marginTop: "6px", opacity: 0.85 } }, event.data.summary) : null : null
          );
        }) : null,
        showMaterials ? (0, import_react.createElement)(
          "div",
          { style: { marginTop: "8px", border: "1px solid var(--dsw-border, #d0d7de)", borderRadius: "8px", padding: "10px" } },
          (0, import_react.createElement)(
            "div",
            { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
            (0, import_react.createElement)("strong", { style: { fontSize: "13px" } }, "\u{1F4C4} \u7B2C\u4E00\u6B65 \xB7 \u6750\u6599\u51C6\u5907"),
            (0, import_react.createElement)("button", { style: S.smallLink, onClick: () => setShowMaterials(false) }, "\u2715 \u6536\u8D77")
          ),
          (meta.sources ?? []).length === 0 ? (0, import_react.createElement)("p", { style: { margin: "6px 0 0", fontSize: "12px", opacity: 0.7 } }, "\u8FD8\u6CA1\u6709\u4E0A\u4F20\u6750\u6599\u3002") : (meta.sources ?? []).map(
            (source) => (0, import_react.createElement)(
              "div",
              { key: source.file, style: { margin: "6px 0", display: "flex", gap: "8px", alignItems: "center" } },
              (0, import_react.createElement)(
                "span",
                { style: { flex: 1, fontSize: "12px", wordBreak: "break-all" } },
                `${source.converted === true ? "\u2705" : "\u23F3"} ${source.file}\uFF08${source.role ?? ""}\uFF09`
              ),
              source.converted === true && typeof source.md === "string" && source.md !== "" ? (0, import_react.createElement)("button", {
                style: S.smallLink,
        ...
        browsing === null && viewing !== null && viewText !== null ? (0, import_react.createElement)(FileViewer, { viewing, viewText, onClose: () => setViewing(null) }) : null
      ),
      // 下：对话台（右下镜像宿主对话；分界可拖、可收成一条）。焦点区在它上面独立滚动。
      // 收起态（默认）压成单行高，只留「展开对话台」入口；展开态才是对话区本体。
      (0, import_react.createElement)(
        "div",
        { ref: deskRef, style: { height: deskCollapsed ? "32px" : `${deskLiveRef.current ?? deskHeight}px`, flexShrink: 0, borderTop: "1px solid var(--dsw-border, #d0d7de)", position: "relative" } },
        (0, import_react.createElement)("div", {
          // 拖拽分界手柄
          style: { position: "absolute", top: "-4px", left: 0, right: 0, height: "8px", cursor: "ns-resize" },
          onMouseDown: startDeskDrag
        }),
        deskCollapsed ? (0, import_react.createElement)("button", { style: { ...S.smallLink, margin: "6px auto", display: "block" }, onClick: () => setDeskCollapsed(false) }, "\u{1F91D} \u5C55\u5F00\u5BF9\u8BDD\u53F0") : (0, import_react.createElement)(ChatDesk, {
          useSession: props.useSession,
          events,
          // Task 20 回执徽章用（workbench 事件数组）
          onNudge: () => {
            void postAction({ action: "nudge", text: "\u5DE5\u4F5C\u53F0\u8FD8\u6CA1\u8DDF\u4E0A\uFF0C\u8BF7\u628A\u521A\u624D\u7B54\u5E94\u7684\u4E8B\u843D\u8D26\uFF08style-note/progress \u7B49\uFF09" });
          },
  ...
  return (0, import_react.createElement)(
    ...
    topBar,
    meta !== null && !loading ? projectView() : (0, import_react.createElement)("div", { style: { flex: 1, minHeight: 0, overflow: "auto" } }, simpleContent)
  );
}
...
function renderInline(text) {
  ...
  if (head !== null) return [(0, import_react.createElement)("strong", { style: { fontSize: "16px" } }, ...inlineBold(head[2]))];
  const list = /^[-*]\s+(.+)$/.exec(str);
  if (list !== null) return [(0, import_react.createElement)("span", { style: { display: "block" } }, "\u2022 ", ...inlineBold(list[1]))];
...
function inlineBold(s) {
  ...
  for (let i = 0; i < parts.length; i += 1) {
    if (parts[i] === "") continue;
    nodes.push(i % 2 === 1 ? (0, import_react.createElement)("strong", { key: i }, parts[i].slice(2, -2)) : parts[i]);
  }
  return nodes;
}
